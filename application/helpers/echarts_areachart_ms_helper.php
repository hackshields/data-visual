...
if (!function_exists("make_echarts_areachart_ms")) {
    function make_echarts_areachart_ms($caption, $subcaption, $xAxisName, $yAxisName, $categories, $datasets)
    {
        $serieses = array();
        $legends = array();
        foreach ($datasets as $dataset) {
            $legends[] = $dataset["seriesName"];
            $series = array("name" => $dataset["seriesName"], "type" => "line", "itemStyle" => array("normal" => array("areaStyle" => array("type" => "default"))), "data" => $dataset["datas"]);
            $serieses[] = $series;
        }
