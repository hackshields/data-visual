...
if (!function_exists("echarts_piechart_ms")) {
    function make_echarts_wordcloud_ms($caption, $subcaption, $xAxisName, $yAxisName, $categories, $datasets)
    {
        $serieses = array();
        ...
        return array("tooltip" => array("trigger" => "item", "formatter" => "{a} <br/>{b} : {c} ({d}%)"), "toolbox" => array("show" => false), "calculable" => false, "series" => $serieses);
    }
}
