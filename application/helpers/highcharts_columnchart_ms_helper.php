...
if (!function_exists("make_highcharts_columnchart_ms")) {
    function make_highcharts_columnchart_ms($caption, $subcaption, $xAxisName, $yAxisName, $categories, $datasets)
    {
        $serieses = array();
        $legends = array();
