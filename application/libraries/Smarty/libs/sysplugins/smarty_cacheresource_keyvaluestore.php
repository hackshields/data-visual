...
abstract class Smarty_CacheResource_KeyValueStore extends Smarty_CacheResource
{
    ...
    public function process(Smarty_Internal_Template $_smarty_tpl, Smarty_Template_Cached $cached = NULL, $update = false)
    {
        ...
        if (($content === NULL || !$timestamp) && !$this->fetch($_smarty_tpl->cached->filepath, $_smarty_tpl->source->name, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, $content, $timestamp, $_smarty_tpl->source->uid)) {
            return false;
        }
        if (isset($content)) {
            eval("?>" . $content);
    ...
    public function readCachedContent(Smarty_Internal_Template $_template)
    {
        ...
        $timestamp = NULL;
        if ($content === NULL && !$this->fetch($_template->cached->filepath, $_template->source->name, $_template->cache_id, $_template->compile_id, $content, $timestamp, $_template->source->uid)) {
            return false;
        }
        if (isset($content)) {
            return $content;
