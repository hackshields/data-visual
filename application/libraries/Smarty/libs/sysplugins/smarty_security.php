...
class Smarty_Security
{
    ...
    public static function enableSecurity(Smarty $smarty, $security_class)
    {
        ...
        if ($security_class !== "Smarty_Security" && !is_subclass_of($security_class, "Smarty_Security")) {
    ...
    {
        if (0 < $this->max_template_nesting && $this->max_template_nesting <= $this->_current_template_nesting++) {
    ...
    {
        if (0 < $this->max_template_nesting) {
