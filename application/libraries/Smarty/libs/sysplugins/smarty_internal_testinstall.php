            ...
            if (!$template_dir) {
                if ($smarty->use_include_path && !preg_match("/^([\\/\\\\]|[a-zA-Z]:[\\/\\\\])/", $_template_dir)) {
                    ...
                    if ($template_dir !== false) {
                        if ($errors === NULL) {
                            echo (string) $template_dir . " is OK.\n";
                        }
                        continue;
                    }
                    $status = false;
            ...
            if (!is_dir($_compile_dir)) {
                ...
                if (!is_readable($_compile_dir)) {
                    ...
                    if (!is_writable($_compile_dir)) {
                        ...
                        if ($errors === NULL) {
                            echo (string) $_compile_dir . " is OK.\n";
                        }
                    }
                }
            }
