...
class TCPDF_COLORS
{
     ...
     * @public static
     */
    public static $spotcolor = array("none" => array(0, 0, 0, 0, "None"), "all" => array(100, 100, 100, 100, "All"), "cyan" => array(100, 0, 0, 0, "Cyan"), "magenta" => array(0, 100, 0, 0, "Magenta"), "yellow" => array(0, 0, 100, 0, "Yellow"), "key" => array(0, 0, 0, 100, "Key"), "white" => array(0, 0, 0, 0, "White"), "black" => array(0, 0, 0, 100, "Black"), "red" => array(0, 100, 100, 0, "Red"), "green" => array(100, 0, 100, 0, "Green"), "blue" => array(100, 100, 0, 0, "Blue"));
    /**
    ...
    public static function convertHTMLColorToDec($hcolor, &$spotc, $defcol = array())
    {
        ...
        if (strpos($color, "[") !== false) {
            if (0 < preg_match("/[\\[][\\\"'](t|g|rgb|cmyk)[\\\"'][\\,]?([0-9\\.]*)[\\,]?([0-9\\.]*)[\\,]?([0-9\\.]*)[\\,]?([0-9\\.]*)[\\]]/", $color, $m)) {
                $returncolor = array();
                switch ($m[1]) {
                    case "cmyk":
            ...
            if (substr($color, 0, 4) != "cmyk" && substr($color, 0, 3) != "rgb" && ($dotpos = strpos($color, ".")) !== false) {
