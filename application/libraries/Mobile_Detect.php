...
class Mobile_Detect
{
     ...
     * @var array
     */
    protected static $browsers = array("Chrome" => "\\bCrMo\\b|CriOS|Android.*Chrome/[.0-9]* (Mobile)?", "Dolfin" => "\\bDolfin\\b", "Opera" => "Opera.*Mini|Opera.*Mobi|Android.*Opera|Mobile.*OPR/[0-9.]+\$|Coast/[0-9.]+", "Skyfire" => "Skyfire", "Edge" => "Mobile Safari/[.0-9]* Edge", "IE" => "IEMobile|MSIEMobile", "Firefox" => "fennec|firefox.*maemo|(Mobile|Tablet).*Firefox|Firefox.*Mobile|FxiOS", "Bolt" => "bolt", "TeaShark" => "teashark", "Blazer" => "Blazer", "Safari" => "Version.*Mobile.*Safari|Safari.*Mobile|MobileSafari", "WeChat" => "\\bMicroMessenger\\b", "UCBrowser" => "UC.*Browser|UCWEB", "baiduboxapp" => "baiduboxapp", "baidubrowser" => "baidubrowser", "DiigoBrowser" => "DiigoBrowser", "Puffin" => "Puffin", "Mercury" => "\\bMercury\\b", "ObigoBrowser" => "Obigo", "NetFront" => "NF-Browser", "GenericBrowser" => "NokiaBrowser|OviBrowser|OneBrowser|TwonkyBeamBrowser|SEMC.*Browser|FlyFlow|Minimo|NetFront|Novarra-Vision|MQQBrowser|MicroMessenger", "PaleMoon" => "Android.*PaleMoon|Mobile.*PaleMoon");
    /**
     * Utilities.
     *
     * @var array
    ...
    public function mobileGrade()
    {
        ...
        if ($this->is("iOS") && 4.3 <= $this->version("iPad", self::VERSION_TYPE_FLOAT) || $this->is("iOS") && 4.3 <= $this->version("iPhone", self::VERSION_TYPE_FLOAT) || $this->is("iOS") && 4.3 <= $this->version("iPod", self::VERSION_TYPE_FLOAT) || 2.1 < $this->version("Android", self::VERSION_TYPE_FLOAT) && $this->is("Webkit") || 7.5 <= $this->version("Windows Phone OS", self::VERSION_TYPE_FLOAT) || $this->is("BlackBerry") && 6 <= $this->version("BlackBerry", self::VERSION_TYPE_FLOAT) || $this->match("Playbook.*Tablet") || 1.4 <= $this->version("webOS", self::VERSION_TYPE_FLOAT) && $this->match("Palm|Pre|Pixi") || $this->match("hp.*TouchPad") || $this->is("Firefox") && 18 <= $this->version("Firefox", self::VERSION_TYPE_FLOAT) || $this->is("Chrome") && $this->is("AndroidOS") && 4 <= $this->version("Android", self::VERSION_TYPE_FLOAT) || $this->is("Skyfire") && 4.1 <= $this->version("Skyfire", self::VERSION_TYPE_FLOAT) && $this->is("AndroidOS") && 2.3 <= $this->version("Android", self::VERSION_TYPE_FLOAT) || $this->is("Opera") && 11.5 <= $this->version("Opera Mobi", self::VERSION_TYPE_FLOAT) && $this->is("AndroidOS") || $this->is("MeeGoOS") || $this->is("Tizen") || $this->is("Dolfin") && 2 <= $this->version("Bada", self::VERSION_TYPE_FLOAT) || ($this->is("UC Browser") || $this->is("Dolfin")) && 2.3 <= $this->version("Android", self::VERSION_TYPE_FLOAT) || $this->match("Kindle Fire") || $this->is("Kindle") && 3 <= $this->version("Kindle", self::VERSION_TYPE_FLOAT) || $this->is("AndroidOS") && $this->is("NookTablet") || 16 <= $this->version("Chrome", self::VERSION_TYPE_FLOAT) && !$isMobile || 5 <= $this->version("Safari", self::VERSION_TYPE_FLOAT) && !$isMobile || 10 <= $this->version("Firefox", self::VERSION_TYPE_FLOAT) && !$isMobile || 7 <= $this->version("IE", self::VERSION_TYPE_FLOAT) && !$isMobile || 10 <= $this->version("Opera", self::VERSION_TYPE_FLOAT) && !$isMobile) {
            return self::MOBILE_GRADE_A;
        }
        if ($this->is("iOS") && $this->version("iPad", self::VERSION_TYPE_FLOAT) < 4.3 || $this->is("iOS") && $this->version("iPhone", self::VERSION_TYPE_FLOAT) < 4.3 || $this->is("iOS") && $this->version("iPod", self::VERSION_TYPE_FLOAT) < 4.3 || $this->is("Blackberry") && 5 <= $this->version("BlackBerry", self::VERSION_TYPE_FLOAT) && $this->version("BlackBerry", self::VERSION_TYPE_FLOAT) < 6 || 5 <= $this->version("Opera Mini", self::VERSION_TYPE_FLOAT) && $this->version("Opera Mini", self::VERSION_TYPE_FLOAT) <= 7 && (2.3 <= $this->version("Android", self::VERSION_TYPE_FLOAT) || $this->is("iOS")) || $this->match("NokiaN8|NokiaC7|N97.*Series60|Symbian/3") || 11 <= $this->version("Opera Mobi", self::VERSION_TYPE_FLOAT) && $this->is("SymbianOS")) {
            return self::MOBILE_GRADE_B;
        }
        if ($this->version("BlackBerry", self::VERSION_TYPE_FLOAT) <= 5 || $this->match("MSIEMobile|Windows CE.*Mobile") || $this->version("Windows Mobile", self::VERSION_TYPE_FLOAT) <= 5.2 || $this->is("iOS") && $this->version("iPad", self::VERSION_TYPE_FLOAT) <= 3.2 || $this->is("iOS") && $this->version("iPhone", self::VERSION_TYPE_FLOAT) <= 3.2 || $this->is("iOS") && $this->version("iPod", self::VERSION_TYPE_FLOAT) <= 3.2 || $this->version("IE", self::VERSION_TYPE_FLOAT) <= 7 && !$isMobile) {
