...
class ParseApp
{
    ...
    {
        $result = ParseClient::_request("GET", "apps", null, null, true, true);
    ...
    {
        $result = ParseClient::_request("GET", "apps/" . $application_id, null, null, true, true);
        return $result;
    }
    /**
    ...
    {
        $result = ParseClient::_request("POST", "apps", null, json_encode($data), true, true);
        return $result;
    }
    /**
    ...
    {
        $result = ParseClient::_request("PUT", "apps/" . $application_id, null, json_encode($data), true, true);
        return $result;
    }
}
