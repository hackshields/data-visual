...
class ParseCloud
{
    ...
    public static function run($name, $data = array(), $useMasterKey = false)
    {
        ...
        $response = ParseClient::_request("POST", "functions/" . $name, $sessionToken, json_encode(ParseClient::_encode($data, false)), $useMasterKey);
    ...
    {
        $response = ParseClient::_request("GET", "cloud_code/jobs/data", null, null, true);
     ...
     */
    public static function startJob($jobName, $data = array())
    {
        $response = ParseClient::_request("POST", "jobs/" . $jobName, null, json_encode(ParseClient::_encode($data, false)), true, false, "application/json", true);
