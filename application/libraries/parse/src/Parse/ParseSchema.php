...
class ParseSchema
{
    ...
    public function all()
    {
        ...
        $result = ParseClient::_request("GET", "schemas/", $sessionToken, null, $this->useMasterKey);
    ...
    public function get()
    {
        ...
        $result = ParseClient::_request("GET", "schemas/" . $this->className, $sessionToken, null, $this->useMasterKey);
        if (empty($result)) {
            throw new ParseException("Schema not found.", 101);
        }
        return $result;
    ...
    public function save()
    {
        ...
        $result = ParseClient::_request("POST", "schemas/" . $this->className, $sessionToken, json_encode($schema), $this->useMasterKey);
        if (empty($result)) {
    ...
    public function update()
    {
        ...
        $this->fields = array();
        $this->indexes = array();
        $result = ParseClient::_request("PUT", "schemas/" . $this->className, $sessionToken, json_encode($schema), $this->useMasterKey);
        if (empty($result)) {
    ...
    {
        self::assertClassName();
        $result = ParseClient::_request("DELETE", "purge/" . $this->className, null, null, $this->useMasterKey);
        if (!empty($result)) {
    ...
    public function delete()
    {
        ...
        $result = ParseClient::_request("DELETE", "schemas/" . $this->className, $sessionToken, null, $this->useMasterKey);
        if (!empty($result)) {
    ...
    public function addField($fieldName = NULL, $fieldType = "String")
    {
        ...
        $this->fields[$fieldName] = array("type" => $fieldType);
        return $this;
    }
    /**
    ...
    public function addString($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$STRING);
        return $this;
    }
    /**
     * Adding Number Field.
    ...
    public function addNumber($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$NUMBER);
        return $this;
    }
    /**
    ...
    public function addBoolean($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$BOOLEAN);
        return $this;
    }
    /**
     * Adding Date Field.
    ...
    public function addDate($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$DATE);
        return $this;
    }
    /**
     * Adding File Field.
    ...
    public function addFile($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$FILE);
        return $this;
    }
    /**
    ...
    public function addGeoPoint($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$GEO_POINT);
        return $this;
    }
    /**
    ...
    public function addPolygon($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$POLYGON);
        return $this;
    }
    /**
     * Adding Array Field.
    ...
    public function addArray($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$ARRAY);
        return $this;
    }
    /**
     * Adding Object Field.
    ...
    public function addObject($fieldName = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$OBJECT);
        return $this;
    }
    /**
    ...
    public function addPointer($fieldName = NULL, $targetClass = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$POINTER, "targetClass" => $targetClass);
        return $this;
    }
    /**
    ...
    public function addRelation($fieldName = NULL, $targetClass = NULL)
    {
        ...
        $this->fields[$fieldName] = array("type" => self::$RELATION, "targetClass" => $targetClass);
        return $this;
    }
    /**
    ...
    {
        $this->fields[$fieldName] = array("__op" => "Delete");
    }
    /**
    ...
    {
        $this->indexes[$indexName] = array("__op" => "Delete");
    }
    /**
    ...
    {
        if ($type !== self::$STRING && $type !== self::$NUMBER && $type !== self::$BOOLEAN && $type !== self::$DATE && $type !== self::$FILE && $type !== self::$GEO_POINT && $type !== self::$POLYGON && $type !== self::$ARRAY && $type !== self::$OBJECT && $type !== self::$POINTER && $type !== self::$RELATION) {
