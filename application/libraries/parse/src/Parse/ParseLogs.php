...
class ParseLogs
{
     ...
     * @return array
     */
    public static function getScriptLogs($level = "info", $size = 100, $from = NULL, $until = NULL, $order = NULL)
    {
        $data = array("level" => $level, "size" => $size);
        ...
        $response = ParseClient::_request("GET", "scriptlog", null, $data, true);
        return $response;
    }
    /**
     * Returns info logs
