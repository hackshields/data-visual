 ...
 * @package Parse
 */
class ParseFile implements Internal\Encodable
{
    /**
     * The filename.
     *
    ...
    public function delete($useMasterKey = true)
    {
        ...
        ParseClient::_request("DELETE", "files/" . $this->getName(), null, null, $useMasterKey);
    }
    /**
    ...
    {
        return array("__type" => "File", "url" => $this->url, "name" => $this->name);
    }
    /**
    ...
    private function upload($useMasterKey = false)
    {
        ...
        return ParseClient::_request("POST", "files/" . $this->getName(), null, $this->getData(), $useMasterKey, false, $mimeType);
    }
    /**
