...
class ValueMapper
{
    ...
    private function arrayToParameter(array $array)
    {
        ...
        return [['type' => self::TYPE_ARRAY, 'arrayType' => $type], ['arrayValues' => $values]];
    }
    /**
    ...
    private function timestampFromBigQuery($value)
    {
        ...
        return new Timestamp(new \DateTime(sprintf('%s.%s+00:00', $dateTime->format('Y-m-d H:i:s'), $microSeconds)));
    }
}
