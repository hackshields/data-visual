...
{
    return ['client_id' => 'client123', 'client_secret' => 'clientSecret123', 'refresh_token' => 'refreshToken123', 'type' => 'authorized_user'];
}
...
class URCConstructorTest extends TestCase
{
    ...
    public function testShouldFailIfScopeIsNotAValidType()
    {
        ...
        $sa = new UserRefreshCredentials($notAnArrayOrString, $testJson);
    }
    /**
     * @expectedException InvalidArgumentException
     */
    ...
    public function testInitalizeFromAFile()
    {
        ...
        $this->assertNotNull(new UserRefreshCredentials('scope/1', $keyFile));
    }
    /**
...
class URCFromEnvTest extends TestCase
{
    ...
    {
        putenv(UserRefreshCredentials::ENV_VAR);
        // removes it from
    }
...
class URCFromWellKnownFileTest extends TestCase
{
    ...
    public function testIsNullIfFileDoesNotExist()
    {
        ...
        $this->assertNull(UserRefreshCredentials::fromWellKnownFile('a scope'));
    }
