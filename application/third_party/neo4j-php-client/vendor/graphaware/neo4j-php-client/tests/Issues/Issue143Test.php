...
class Issue143Test extends IntegrationTestCase
{
    public function setUp()
    {
        ...
        $this->client = ClientBuilder::create()->addConnection('a', $connections['non-exist'])->addConnection('http', $connections['http'])->addConnection('bolt', $connections['bolt'])->setMaster('bolt')->build();
    }
