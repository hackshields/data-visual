...
class Configuration extends BaseConfiguration implements ConfigInterface
{
    ...
    {
        return new self(['user' => 'null', 'password' => 'null', 'bind_to_interface' => 'null', 'timeout' => 5, 'credentials' => ['null', 'null']]);
    }
    /**
    ...
    public function withCredentials($username, $password)
    {
        ...
        $new = $this->setValue('username', $username)->setValue('password', $password)->setValue('credentials', [$username, $password]);
        // To keep BC
