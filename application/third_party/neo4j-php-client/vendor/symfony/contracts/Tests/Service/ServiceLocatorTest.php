...
class ServiceLocatorTest extends TestCase
{
    ...
    {
        $locator = $this->getServiceLocator(array('foo' => function () {
            return 'bar';
        }, 'bar' => function () {
            return 'baz';
        }, function () {
    ...
    {
        $i = 0;
        $locator = $this->getServiceLocator(array('foo' => function () use(&$i) {
            ++$i;
            return 'bar';
        }));
        $this->assertSame('bar', $locator->get('foo'));
    ...
    {
        $locator = $this->getServiceLocator(array('foo' => function () use(&$locator) {
