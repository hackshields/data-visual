...
class RegisterListenersPassTest extends TestCase
{
    ...
    public function testValidEventSubscriber()
    {
        ...
        $registerListenersPass = new RegisterListenersPass();
        $registerListenersPass->process($builder);
        $expectedCalls = array(array('addListener', array('event', array(new ServiceClosureArgument(new Reference('my_event_subscriber')), 'onEvent'), 0)));
    ...
    public function testEventSubscriberResolvableClassName()
    {
        ...
        $expectedCalls = array(array('addListener', array('event', array(new ServiceClosureArgument(new Reference('foo')), 'onEvent'), 0)));
    ...
    public function testInvokableEventListener()
    {
        ...
        $registerListenersPass->process($container);
        $definition = $container->getDefinition('event_dispatcher');
        $expectedCalls = array(array('addListener', array('foo.bar', array(new ServiceClosureArgument(new Reference('foo')), 'onFooBar'), 0)), array('addListener', array('foo.bar', array(new ServiceClosureArgument(new Reference('bar')), '__invoke'), 0)), array('addListener', array('event', array(new ServiceClosureArgument(new Reference('baz')), 'onEvent'), 0)));
        $this->assertEquals($expectedCalls, $definition->getMethodCalls());
    }
}
