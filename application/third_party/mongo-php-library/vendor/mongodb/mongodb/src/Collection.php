...
class Collection
{
    ...
    public function aggregate(array $pipeline, array $options = [])
    {
         ...
         */
        if (!isset($options['readConcern']) && !($hasOutStage && $this->readConcern->getLevel() === ReadConcern::MAJORITY) && \MongoDB\server_supports_feature($server, self::$wireVersionForReadConcern)) {
