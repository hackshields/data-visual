...
class MapReduce implements Executable
{
    ...
    public function execute(Server $server)
    {
        ...
        $cursor = $hasOutputCollection ? $server->executeReadWriteCommand($this->databaseName, $command, $options) : $server->executeReadCommand($this->databaseName, $command, $options);
