...
class CacheMetadataFactoryTest extends TestCase
{
    public function testGetMetadataFor()
    {
        ...
        $decorated->expects($this->once())->method('getMetadataFor')->will($this->returnValue($metadata));
    ...
    {
        $decorated = $this->getMockBuilder(ClassMetadataFactoryInterface::class)->getMock();
        $decorated->expects($this->once())->method('hasMetadataFor')->will($this->returnValue(true));
        $factory = new CacheClassMetadataFactory($decorated, new ArrayAdapter());
