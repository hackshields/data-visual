...
class DateTimeNormalizerTest extends TestCase
{
    ...
    {
        $this->assertSame($expected, $this->normalizer->normalize($input, null, array(DateTimeNormalizer::TIMEZONE_KEY => $timezone)));
    }
    ...
    public function testDenormalizeUsingTimezonePassedInConstructor()
    {
        ...
        $this->assertEquals($expected, $normalizer->denormalize('2016.12.01 17:35:00', \DateTime::class, null, array(DateTimeNormalizer::FORMAT_KEY => 'Y.m.d H:i:s')));
    }
    ...
    {
        $actual = $this->normalizer->denormalize($input, \DateTimeInterface::class, null, array(DateTimeNormalizer::TIMEZONE_KEY => $timezone, DateTimeNormalizer::FORMAT_KEY => $format));
        $this->assertEquals($expected, $actual);
    }
    public function denormalizeUsingTimezonePassedInContextProvider()
    {
        (yield 'with timezone' => array('2016/12/01 17:35:00', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('Japan')), new \DateTimeZone('Japan')));
        (yield 'with timezone as string' => array('2016/12/01 17:35:00', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('Japan')), 'Japan'));
        (yield 'with format without timezone information' => array('2016.12.01 17:35:00', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('Japan')), new \DateTimeZone('Japan'), 'Y.m.d H:i:s'));
        (yield 'ignored with format with timezone information' => array('2016-12-01T17:35:00Z', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('UTC')), 'Europe/Paris', \DateTime::RFC3339));
    }
    /**
