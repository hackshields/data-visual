...
class GetSetMethodNormalizerTest extends TestCase
{
    ...
    {
        $obj = $this->normalizer->denormalize(array('foo' => 'foo', 'bar' => 'bar', 'baz' => true, 'fooBar' => 'foobar'), __NAMESPACE__ . '\\GetSetDummy', 'any');
    ...
    {
        $obj = $this->normalizer->denormalize(array('foo' => 'foo', 'bar' => 'bar', 'baz' => true, 'fooBar' => 'foobar'), __NAMESPACE__ . '\\GetConstructorDummy', 'any');
        $this->assertEquals('foo', $obj->getFoo());
        $this->assertEquals('bar', $obj->getBar());
        $this->assertTrue($obj->isBaz());
    }
    ...
    {
        $obj = $this->normalizer->denormalize(array('foo' => 'foo', 'bar' => null, 'baz' => true), __NAMESPACE__ . '\\GetConstructorDummy', 'any');
        $this->assertEquals('foo', $obj->getFoo());
    ...
    {
        $obj = $this->normalizer->denormalize(array('foo' => 'test', 'baz' => array(1, 2, 3)), __NAMESPACE__ . '\\GetConstructorOptionalArgsDummy', 'any');
    ...
    {
        $obj = $this->normalizer->denormalize(array('bar' => 'test'), __NAMESPACE__ . '\\GetConstructorArgsWithDefaultValueDummy', 'any');
        $this->assertEquals(array(), $obj->getFoo());
        $this->assertEquals('test', $obj->getBar());
    }
    public function testConstructorDenormalizeWithVariadicArgument()
    {
        $obj = $this->normalizer->denormalize(array('foo' => array(1, 2, 3)), 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\VariadicConstructorArgsDummy', 'any');
        $this->assertEquals(array(1, 2, 3), $obj->getFoo());
    }
    public function testConstructorDenormalizeWithMissingVariadicArgument()
    {
        $obj = $this->normalizer->denormalize(array(), 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\VariadicConstructorArgsDummy', 'any');
        $this->assertEquals(array(), $obj->getFoo());
    }
    ...
    public function testGroupsNormalize()
    {
        ...
        $this->assertEquals(array('bar' => 'bar'), $this->normalizer->normalize($obj, null, array(GetSetMethodNormalizer::GROUPS => array('c'))));
        $this->assertEquals(array('symfony' => 'symfony', 'foo' => 'foo', 'fooBar' => 'fooBar', 'bar' => 'bar', 'kevin' => 'kevin', 'coopTilleuls' => 'coopTilleuls'), $this->normalizer->normalize($obj, null, array(GetSetMethodNormalizer::GROUPS => array('a', 'c'))));
    }
    public function testGroupsDenormalize()
    {
        ...
        $normalized = $this->normalizer->denormalize($toNormalize, 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\GroupDummy', null, array(GetSetMethodNormalizer::GROUPS => array('a')));
        $this->assertEquals($obj, $normalized);
        $obj->setBar('bar');
        $normalized = $this->normalizer->denormalize($toNormalize, 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\GroupDummy', null, array(GetSetMethodNormalizer::GROUPS => array('a', 'b')));
        $this->assertEquals($obj, $normalized);
    }
    public function testGroupsNormalizeWithNameConverter()
    {
        ...
        $this->assertEquals(array('bar' => null, 'foo_bar' => '@dunglas', 'symfony' => '@coopTilleuls'), $this->normalizer->normalize($obj, null, array(GetSetMethodNormalizer::GROUPS => array('name_converter'))));
    }
    public function testGroupsDenormalizeWithNameConverter()
    {
        ...
        $obj->setFooBar('@dunglas');
        $obj->setSymfony('@coopTilleuls');
        $this->assertEquals($obj, $this->normalizer->denormalize(array('bar' => null, 'foo_bar' => '@dunglas', 'symfony' => '@coopTilleuls', 'coop_tilleuls' => 'les-tilleuls.coop'), 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\GroupDummy', null, array(GetSetMethodNormalizer::GROUPS => array('name_converter'))));
    }
    /**
    ...
    public function provideCallbacks()
    {
        return array(array(array('bar' => function ($bar) {
            ...
            return $foos;
        }), array(new GetConstructorDummy('baz', '', false), new GetConstructorDummy('quux', '', false)), array('foo' => '', 'bar' => 'bazquux', 'baz' => true), 'Collect a property'), array(array('bar' => function ($bars) {
            return \count($bars);
        }), array(new GetConstructorDummy('baz', '', false), new GetConstructorDummy('quux', '', false)), array('foo' => '', 'bar' => 2, 'baz' => true), 'Count a property'));
    }
    /**
    ...
    public function testSiblingReference()
    {
        ...
        $expected = array('sibling0' => array('coopTilleuls' => 'Les-Tilleuls.coop'), 'sibling1' => array('coopTilleuls' => 'Les-Tilleuls.coop'), 'sibling2' => array('coopTilleuls' => 'Les-Tilleuls.coop'));
    ...
    public function testObjectToPopulate()
    {
        ...
        $dummy->setFoo('foo');
        $obj = $this->normalizer->denormalize(array('bar' => 'bar'), __NAMESPACE__ . '\\GetSetDummy', null, array(GetSetMethodNormalizer::OBJECT_TO_POPULATE => $dummy));
    ...
    {
        $this->assertEquals(new GetSetDummy(), $this->normalizer->denormalize(array('non_existing' => true), __NAMESPACE__ . '\\GetSetDummy'));
    }
    ...
    public function testHasGetterNormalize()
    {
        ...
        $obj->setFoo(true);
        $this->assertEquals(array('foo' => true), $this->normalizer->normalize($obj, 'any'));
    }
