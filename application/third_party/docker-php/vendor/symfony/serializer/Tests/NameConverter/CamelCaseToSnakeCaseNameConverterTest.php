...
class CamelCaseToSnakeCaseNameConverterTest extends TestCase
{
    ...
    {
        return array(array('coop_tilleuls', 'coopTilleuls', true), array('_kevin_dunglas', '_kevinDunglas', true), array('this_is_a_test', 'thisIsATest', true), array('coop_tilleuls', 'CoopTilleuls', false), array('_kevin_dunglas', '_kevinDunglas', false), array('this_is_a_test', 'ThisIsATest', false));
    }
}
