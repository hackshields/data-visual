...
class ChainEncoderTest extends TestCase
{
    ...
    {
        $this->encoder1 = $this->getMockBuilder('Symfony\\Component\\Serializer\\Encoder\\EncoderInterface')->getMock();
        $this->encoder1->method('supportsEncoding')->will($this->returnValueMap(array(array(self::FORMAT_1, array(), true), array(self::FORMAT_2, array(), false), array(self::FORMAT_3, array(), false), array(self::FORMAT_3, array('foo' => 'bar'), true))));
        $this->encoder2 = $this->getMockBuilder('Symfony\\Component\\Serializer\\Encoder\\EncoderInterface')->getMock();
        $this->encoder2->method('supportsEncoding')->will($this->returnValueMap(array(array(self::FORMAT_1, array(), false), array(self::FORMAT_2, array(), true), array(self::FORMAT_3, array(), false))));
    ...
    {
        $chainEncoder = $this->getMockBuilder('Symfony\\Component\\Serializer\\Tests\\Encoder\\ChainNormalizationAwareEncoder')->getMock();
