...
class ChainDecoderTest extends TestCase
{
    ...
    {
        $this->decoder1 = $this->getMockBuilder('Symfony\\Component\\Serializer\\Encoder\\DecoderInterface')->getMock();
        $this->decoder1->method('supportsDecoding')->will($this->returnValueMap(array(array(self::FORMAT_1, array(), true), array(self::FORMAT_2, array(), false), array(self::FORMAT_3, array(), false), array(self::FORMAT_3, array('foo' => 'bar'), true))));
        $this->decoder2 = $this->getMockBuilder('Symfony\\Component\\Serializer\\Encoder\\DecoderInterface')->getMock();
        $this->decoder2->method('supportsDecoding')->will($this->returnValueMap(array(array(self::FORMAT_1, array(), false), array(self::FORMAT_2, array(), true), array(self::FORMAT_3, array(), false))));
