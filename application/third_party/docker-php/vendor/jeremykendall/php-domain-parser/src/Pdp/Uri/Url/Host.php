...
class Host
{
    ...
    public function __toString()
    {
        ...
        $str = array_filter(array($this->subdomain, $this->registrableDomain), 'strlen');
        return implode('.', $str);
    }
    /**
    ...
    public function toArray()
    {
        ...
        return array('subdomain' => $this->getSubdomain(), 'registrableDomain' => $registrableDomain, 'registerableDomain' => $registrableDomain, 'publicSuffix' => $this->getPublicSuffix(), 'host' => $this->getHost());
    }
}
