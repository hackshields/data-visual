...
class Url
{
    ...
    {
        return array('scheme' => $this->getScheme(), 'user' => $this->getUser(), 'pass' => $this->getPass(), 'host' => $this->getHost()->__toString(), 'subdomain' => $this->getHost()->getSubdomain(), 'registrableDomain' => $this->getHost()->getRegistrableDomain(), 'publicSuffix' => $this->getHost()->getPublicSuffix(), 'port' => $this->getPort(), 'path' => $this->getPath(), 'query' => $this->getQuery(), 'fragment' => $this->getFragment());
    }
    /**
     * Get Scheme.
     *
