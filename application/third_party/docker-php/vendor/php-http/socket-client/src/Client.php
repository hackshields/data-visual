...
class Client implements HttpClient
{
    use RequestWriter;
    use ResponseReader;
    private $config = ['remote_socket' => null, 'timeout' => null, 'stream_context_options' => [], 'stream_context_param' => [], 'ssl' => null, 'write_buffer_size' => 8192, 'ssl_method' => STREAM_CRYPTO_METHOD_TLS_CLIENT];
    /**
     * Constructor.
     *
