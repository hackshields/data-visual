...
class RedirectPlugin implements Plugin
{
     ...
     * @var array
     */
    protected $redirectCodes = [300 => ['switch' => ['unless' => ['GET', 'HEAD'], 'to' => 'GET'], 'multiple' => true, 'permanent' => false], 301 => ['switch' => ['unless' => ['GET', 'HEAD'], 'to' => 'GET'], 'multiple' => false, 'permanent' => true], 302 => ['switch' => ['unless' => ['GET', 'HEAD'], 'to' => 'GET'], 'multiple' => false, 'permanent' => false], 303 => ['switch' => ['unless' => ['GET', 'HEAD'], 'to' => 'GET'], 'multiple' => false, 'permanent' => false], 307 => ['switch' => false, 'multiple' => false, 'permanent' => false], 308 => ['switch' => false, 'multiple' => false, 'permanent' => true]];
    /**
    ...
    public function __construct(array $config = [])
    {
        ...
        $resolver->setDefaults(['preserve_header' => true, 'use_default_for_multiple' => true]);
