...
trait ImmutableCollectionTrait
{
    ...
    {
        static $flags_list = [Collection::FILTER_USE_VALUE => 1, Collection::FILTER_USE_BOTH => 1, Collection::FILTER_USE_KEY => 1];
     ...
     * @return Collection
     */
    protected abstract function newCollectionInstance(array $data);
    /**
