...
class Ftp extends AbstractHierarchicalUri implements Uri
{
     ...
     * @inheritdoc
     */
    protected static $supportedSchemes = ['ftp' => 21];
    /**
     * @inheritdoc
     */
    ...
    {
        return null === $this->fragment->getContent() && null === $this->query->getContent() && $this->isValidGenericUri() && $this->isValidHierarchicalUri();
    }
}
