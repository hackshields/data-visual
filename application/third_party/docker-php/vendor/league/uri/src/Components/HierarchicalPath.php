...
class HierarchicalPath extends AbstractHierarchicalComponent implements HierarchicalPathInterface
{
    ...
    {
        return $this->createFromSegments($this->validateComponent($component), $this->isAbsolute)->append($this->__toString());
    }
    /**
    ...
    public function append($component)
    {
        ...
        return $this->createFromSegments(array_merge($source, iterator_to_array($this->validateComponent($component))), $this->isAbsolute);
    }
    /**
    ...
    {
        return str_replace(['\\', "\0"], [static::$separator, '\\'], dirname(str_replace('\\', "\0", $this->__toString())));
    }
    /**
