...
class Host extends AbstractHierarchicalComponent implements HostInterface
{
    ...
    public function toAscii()
    {
        ...
        return $this->withContent($this->format($this->convertToAscii($this->data, $this->isIdn), $this->isAbsolute));
    }
    /**
    ...
    {
        return $this->createFromLabels($this->validateComponent($component), $this->isAbsolute)->append($this->__toString());
    }
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->createFromLabels(array_merge(iterator_to_array($this->validateComponent($component)), $this->getLabels()), $this->isAbsolute);
    }
}
