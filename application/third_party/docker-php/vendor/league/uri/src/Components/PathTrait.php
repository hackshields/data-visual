...
trait PathTrait
{
     ...
     * @var array
     */
    protected static $typecodeList = ['a' => PathInterface::FTP_TYPE_ASCII, 'i' => PathInterface::FTP_TYPE_BINARY, 'd' => PathInterface::FTP_TYPE_DIRECTORY, '' => PathInterface::FTP_TYPE_EMPTY];
    /**
     * Dot Segment pattern
     *
     * @var array
    ...
    protected function filterEncodedPath($str)
    {
        ...
        throw new InvalidArgumentException(sprintf('The encoded path `%s` contains invalid characters', $str));
    }
    /**
     ...
     * @return static
     */
    public abstract function withContent($value = null);
    /**
