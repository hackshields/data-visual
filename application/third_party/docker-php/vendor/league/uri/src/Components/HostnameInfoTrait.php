...
trait HostnameInfoTrait
{
     ...
     * @var array
     */
    protected $hostnameInfo = ['isPublicSuffixValid' => false, 'publicSuffix' => '', 'registerableDomain' => '', 'subdomain' => ''];
    /**
    ...
    protected function loadHostnameInfo()
    {
        ...
        $this->hostnameInfo = array_merge($this->hostnameInfo, array_map('sprintf', $this->getPdpParser()->parseHost($host)->toArray()));
