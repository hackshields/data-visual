...
class DataPath extends AbstractComponent implements DataPathInterface
{
    ...
    public function toBinary()
    {
        ...
        return new static($this->format($this->mimetype, $this->getParameters(), !$this->isBinaryData, base64_encode(rawurldecode($this->document))));
    }
    /**
    ...
    public function toAscii()
    {
        ...
        return new static($this->format($this->mimetype, $this->getParameters(), !$this->isBinaryData, rawurlencode(base64_decode($this->document))));
    }
    /**
    ...
    public function withParameters($parameters)
    {
        ...
        return new static($this->format($this->mimetype, $parameters, $this->isBinaryData, $this->document));
    }
    /**
    ...
    public static function createFromPath($path)
    {
        ...
        return new static(static::format(str_replace(' ', '', (new \finfo(FILEINFO_MIME))->file($path)), '', true, base64_encode(file_get_contents($path))));
    }
    /**
     * @inheritdoc
     */
    ...
    {
        return new static(static::format($properties['mimetype'], implode(';', $properties['parameters']), $properties['isBinaryData'], $properties['document']));
    }
}
