...
class Formatter
{
    ...
    public function format($input)
    {
        ...
        throw new InvalidArgumentException('input must be an URI object or a League UriPart object');
    }
    /**
    ...
    protected function formatUri($uri)
    {
        ...
        return $scheme . $this->formatAuthority($uri) . $path . $this->formatQuery($uri) . $this->formatFragment($uri);
    }
    /**
    ...
    protected function formatAuthority($uri)
    {
        ...
        return '//' . $userInfo . $this->formatHost(new Host($uri->getHost())) . $this->formatPort($uri->getPort());
    }
    /**
