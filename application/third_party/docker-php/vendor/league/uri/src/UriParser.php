...
class UriParser
{
    ...
    public function parse($uri)
    {
        ...
        return $this->normalizeUriHash(array_merge($this->parseAuthority($parts['authority']), ['scheme' => '' === $parts['scheme'] ? null : $parts['scheme'], 'path' => $parts['path'], 'query' => '' === $parts['query'] ? null : mb_substr($parts['query'], 1, null, 'UTF-8'), 'fragment' => '' === $parts['fragment'] ? null : mb_substr($parts['fragment'], 1, null, 'UTF-8')]));
    }
    /**
     * Parse a string as an URI according to the regexp form rfc3986
     *
