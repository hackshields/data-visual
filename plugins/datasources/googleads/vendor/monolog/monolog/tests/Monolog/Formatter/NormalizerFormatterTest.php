...
class NormalizerFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testExceptionTraceDoesNotLeakCallUserFuncArgs()
    {
        ...
        $record = array('context' => array('exception' => $e));
        $result = $formatter->format($record);
        $this->assertSame('{"function":"throwHelper","class":"Monolog\\\\Formatter\\\\NormalizerFormatterTest","type":"->","args":["[object] (Monolog\\\\Formatter\\\\TestInfoLeak)","' . $dt->format('Y-m-d H:i:s') . '"]}', $result['context']['exception']['trace'][0]);
    }
