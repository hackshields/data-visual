...
class ChainDecoderTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->decoder1->method('supportsDecoding')->will($this->returnValueMap([[self::FORMAT_1, [], true], [self::FORMAT_2, [], false], [self::FORMAT_3, [], false], [self::FORMAT_3, ['foo' => 'bar'], true]]));
        $this->decoder2 = $this->getMockBuilder('Symfony\\Component\\Serializer\\Encoder\\DecoderInterface')->getMock();
        $this->decoder2->method('supportsDecoding')->will($this->returnValueMap([[self::FORMAT_1, [], false], [self::FORMAT_2, [], true], [self::FORMAT_3, [], false]]));
