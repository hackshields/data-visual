...
class ChainEncoderTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->encoder1->method('supportsEncoding')->will($this->returnValueMap([[self::FORMAT_1, [], true], [self::FORMAT_2, [], false], [self::FORMAT_3, [], false], [self::FORMAT_3, ['foo' => 'bar'], true]]));
        $this->encoder2 = $this->getMockBuilder('Symfony\\Component\\Serializer\\Encoder\\EncoderInterface')->getMock();
        $this->encoder2->method('supportsEncoding')->will($this->returnValueMap([[self::FORMAT_1, [], false], [self::FORMAT_2, [], true], [self::FORMAT_3, [], false]]));
