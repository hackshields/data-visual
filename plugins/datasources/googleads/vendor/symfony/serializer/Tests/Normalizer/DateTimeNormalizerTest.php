...
class DateTimeNormalizerTest extends TestCase
{
    ...
    {
        $this->assertSame($expected, $this->normalizer->normalize($input, null, [DateTimeNormalizer::TIMEZONE_KEY => $timezone]));
    }
    ...
    {
        $this->assertSame($expected, $this->normalizer->normalize($input, null, [DateTimeNormalizer::TIMEZONE_KEY => $timezone, DateTimeNormalizer::FORMAT_KEY => $expectedFormat]));
    }
    public function normalizeUsingTimeZonePassedInContextAndExpectedFormatWithMicrosecondsProvider()
    {
        (yield ['2018-12-01T18:03:06.067634', 'Y-m-d\\TH:i:s.u', \DateTime::createFromFormat('Y-m-d\\TH:i:s.u', '2018-12-01T18:03:06.067634', new \DateTimeZone('UTC')), null]);
        (yield ['2018-12-01T18:03:06.067634', 'Y-m-d\\TH:i:s.u', \DateTime::createFromFormat('Y-m-d\\TH:i:s.u', '2018-12-01T18:03:06.067634', new \DateTimeZone('UTC')), new \DateTimeZone('UTC')]);
        (yield ['2018-12-01T19:03:06.067634+01:00', 'Y-m-d\\TH:i:s.uP', \DateTimeImmutable::createFromFormat('Y-m-d\\TH:i:s.u', '2018-12-01T18:03:06.067634', new \DateTimeZone('UTC')), new \DateTimeZone('Europe/Rome')]);
        (yield ['2018-12-01T20:03:06.067634+02:00', 'Y-m-d\\TH:i:s.uP', \DateTime::createFromFormat('Y-m-d\\TH:i:s.u', '2018-12-01T18:03:06.067634', new \DateTimeZone('UTC')), new \DateTimeZone('Europe/Kiev')]);
        (yield ['2018-12-01T19:03:06.067634', 'Y-m-d\\TH:i:s.u', \DateTime::createFromFormat('Y-m-d\\TH:i:s.u', '2018-12-01T18:03:06.067634', new \DateTimeZone('UTC')), new \DateTimeZone('Europe/Berlin')]);
    }
    /**
    ...
    private function doTestDenormalizeUsingTimezonePassedInConstructor(bool $legacy = false)
    {
        ...
        $this->assertEquals($expected, $normalizer->denormalize('2016.12.01 17:35:00', \DateTime::class, null, [DateTimeNormalizer::FORMAT_KEY => 'Y.m.d H:i:s']));
    }
    ...
    {
        $actual = $this->normalizer->denormalize($input, \DateTimeInterface::class, null, [DateTimeNormalizer::TIMEZONE_KEY => $timezone, DateTimeNormalizer::FORMAT_KEY => $format]);
        $this->assertEquals($expected, $actual);
    }
    public function denormalizeUsingTimezonePassedInContextProvider()
    {
        (yield 'with timezone' => ['2016/12/01 17:35:00', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('Japan')), new \DateTimeZone('Japan')]);
        (yield 'with timezone as string' => ['2016/12/01 17:35:00', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('Japan')), 'Japan']);
        (yield 'with format without timezone information' => ['2016.12.01 17:35:00', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('Japan')), new \DateTimeZone('Japan'), 'Y.m.d H:i:s']);
        (yield 'ignored with format with timezone information' => ['2016-12-01T17:35:00Z', new \DateTimeImmutable('2016/12/01 17:35:00', new \DateTimeZone('UTC')), 'Europe/Paris', \DateTime::RFC3339]);
    }
    /**
