...
class GetSetMethodNormalizerTest extends TestCase
{
    ...
    {
        $obj = $this->normalizer->denormalize(['foo' => 'foo', 'bar' => 'bar', 'baz' => true, 'fooBar' => 'foobar'], __NAMESPACE__ . '\\GetSetDummy', 'any');
    ...
    {
        $obj = $this->normalizer->denormalize(['foo' => 'foo', 'bar' => 'bar', 'baz' => true, 'fooBar' => 'foobar'], __NAMESPACE__ . '\\GetConstructorDummy', 'any');
        $this->assertEquals('foo', $obj->getFoo());
        $this->assertEquals('bar', $obj->getBar());
        $this->assertTrue($obj->isBaz());
    }
    ...
    {
        $obj = $this->normalizer->denormalize(['foo' => 'foo', 'bar' => null, 'baz' => true], __NAMESPACE__ . '\\GetConstructorDummy', 'any');
        $this->assertEquals('foo', $obj->getFoo());
    ...
    {
        $obj = $this->normalizer->denormalize(['foo' => 'test', 'baz' => [1, 2, 3]], __NAMESPACE__ . '\\GetConstructorOptionalArgsDummy', 'any');
    ...
    {
        $obj = $this->normalizer->denormalize(['bar' => 'test'], __NAMESPACE__ . '\\GetConstructorArgsWithDefaultValueDummy', 'any');
        $this->assertEquals([], $obj->getFoo());
        $this->assertEquals('test', $obj->getBar());
    }
    public function testConstructorDenormalizeWithVariadicArgument()
    {
        $obj = $this->normalizer->denormalize(['foo' => [1, 2, 3]], 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\VariadicConstructorArgsDummy', 'any');
        $this->assertEquals([1, 2, 3], $obj->getFoo());
    }
    public function testConstructorDenormalizeWithMissingVariadicArgument()
    {
        $obj = $this->normalizer->denormalize([], 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\VariadicConstructorArgsDummy', 'any');
        $this->assertEquals([], $obj->getFoo());
    }
    ...
    public function testGroupsNormalize()
    {
        ...
        $this->assertEquals(['bar' => 'bar'], $this->normalizer->normalize($obj, null, [GetSetMethodNormalizer::GROUPS => ['c']]));
        $this->assertEquals(['symfony' => 'symfony', 'foo' => 'foo', 'fooBar' => 'fooBar', 'bar' => 'bar', 'kevin' => 'kevin', 'coopTilleuls' => 'coopTilleuls'], $this->normalizer->normalize($obj, null, [GetSetMethodNormalizer::GROUPS => ['a', 'c']]));
    }
    public function testGroupsDenormalize()
    {
        ...
        $normalized = $this->normalizer->denormalize($toNormalize, 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\GroupDummy', null, [GetSetMethodNormalizer::GROUPS => ['a']]);
        $this->assertEquals($obj, $normalized);
        $obj->setBar('bar');
        $normalized = $this->normalizer->denormalize($toNormalize, 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\GroupDummy', null, [GetSetMethodNormalizer::GROUPS => ['a', 'b']]);
        $this->assertEquals($obj, $normalized);
    }
    public function testGroupsNormalizeWithNameConverter()
    {
        ...
        $this->assertEquals(['bar' => null, 'foo_bar' => '@dunglas', 'symfony' => '@coopTilleuls'], $this->normalizer->normalize($obj, null, [GetSetMethodNormalizer::GROUPS => ['name_converter']]));
    }
    public function testGroupsDenormalizeWithNameConverter()
    {
        ...
        $obj->setFooBar('@dunglas');
        $obj->setSymfony('@coopTilleuls');
        $this->assertEquals($obj, $this->normalizer->denormalize(['bar' => null, 'foo_bar' => '@dunglas', 'symfony' => '@coopTilleuls', 'coop_tilleuls' => 'les-tilleuls.coop'], 'Symfony\\Component\\Serializer\\Tests\\Fixtures\\GroupDummy', null, [GetSetMethodNormalizer::GROUPS => ['name_converter']]));
    }
    /**
    ...
    public function provideCallbacks()
    {
        return [[['bar' => function ($bar) {
            return 'baz';
        }], 'baz', ['foo' => '', 'bar' => 'baz', 'baz' => true], 'Change a string'], [['bar' => function ($bar) {
            ...
            return $foos;
        }], [new GetConstructorDummy('baz', '', false), new GetConstructorDummy('quux', '', false)], ['foo' => '', 'bar' => 'bazquux', 'baz' => true], 'Collect a property'], [['bar' => function ($bars) {
            return \count($bars);
        }], [new GetConstructorDummy('baz', '', false), new GetConstructorDummy('quux', '', false)], ['foo' => '', 'bar' => 2, 'baz' => true], 'Count a property']];
    }
    /**
    ...
    public function testObjectToPopulate()
    {
        ...
        $dummy->setFoo('foo');
        $obj = $this->normalizer->denormalize(['bar' => 'bar'], __NAMESPACE__ . '\\GetSetDummy', null, [GetSetMethodNormalizer::OBJECT_TO_POPULATE => $dummy]);
    ...
    {
        $this->assertEquals(new GetSetDummy(), $this->normalizer->denormalize(['non_existing' => true], __NAMESPACE__ . '\\GetSetDummy'));
    }
    ...
    public function testHasGetterNormalize()
    {
        ...
        $obj->setFoo(true);
        $this->assertEquals(['foo' => true], $this->normalizer->normalize($obj, 'any'));
    }
    public function testMaxDepth()
    {
        ...
        $expected = ['bar' => 'level1', 'child' => ['bar' => 'level2', 'child' => ['bar' => 'level3', 'child' => ['child' => null]]]];
