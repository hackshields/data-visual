...
class AbstractObjectNormalizerTest extends TestCase
{
    ...
    public function testDenormalizeWithExtraAttributes()
    {
        ...
        $normalizer->denormalize(['fooFoo' => 'foo', 'fooBar' => 'bar'], __NAMESPACE__ . '\\Dummy', 'any', ['allow_extra_attributes' => false]);
    }
    /**
     * @expectedException \Symfony\Component\Serializer\Exception\ExtraAttributesException
     * @expectedExceptionMessage Extra attributes are not allowed ("fooFoo", "fooBar" are unknown).
    ...
    public function testDenormalizeWithExtraAttributesAndNoGroupsWithMetadataFactory()
    {
        ...
        $normalizer->denormalize(['fooFoo' => 'foo', 'fooBar' => 'bar', 'bar' => 'bar'], Dummy::class, 'any', ['allow_extra_attributes' => false]);
    }
    public function testDenormalizeCollectionDecodedFromXmlWithOneChild()
    {
        $denormalizer = $this->getDenormalizerForDummyCollection();
        $dummyCollection = $denormalizer->denormalize(['children' => ['bar' => 'first']], DummyCollection::class, 'xml');
    ...
    {
        $denormalizer = $this->getDenormalizerForDummyCollection();
        $dummyCollection = $denormalizer->denormalize(['children' => [['bar' => 'first'], ['bar' => 'second']]], DummyCollection::class, 'xml');
        $this->assertInstanceOf(DummyCollection::class, $dummyCollection);
        $this->assertInternalType('array', $dummyCollection->children);
    ...
    private function getDenormalizerForDummyCollection()
    {
        ...
        $extractor->method('getTypes')->will($this->onConsecutiveCalls([new Type('array', false, null, true, new Type('int'), new Type('object', false, DummyChild::class))], null));
    ...
    public function testExtraAttributesException()
    {
        ...
        $normalizer->denormalize([], \stdClass::class, 'xml', ['allow_extra_attributes' => false]);
    }
