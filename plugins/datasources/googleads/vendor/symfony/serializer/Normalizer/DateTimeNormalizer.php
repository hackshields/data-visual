...
class DateTimeNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    ...
    private static $supportedTypes = [\DateTimeInterface::class => true, \DateTimeImmutable::class => true, \DateTime::class => true];
    /**
     * @param array $defaultContext
     */
    public function __construct($defaultContext = [], \DateTimeZone $timezone = null)
    {
        $this->defaultContext = [self::FORMAT_KEY => \DateTime::RFC3339, self::TIMEZONE_KEY => null];
