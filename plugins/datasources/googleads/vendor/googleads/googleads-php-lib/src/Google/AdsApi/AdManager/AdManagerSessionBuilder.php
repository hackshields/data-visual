...
final class AdManagerSessionBuilder implements AdsBuilder
{
    ...
    {
        $this->networkCode = $configuration->getConfiguration('networkCode', 'AD_MANAGER');
        $this->applicationName = $configuration->getConfiguration('applicationName', 'AD_MANAGER');
        $this->endpoint = $configuration->getConfiguration('endpoint', 'AD_MANAGER');
    ...
    public function validate()
    {
        ...
        if ($this->applicationName === null || trim($this->applicationName) === '' || strpos($this->applicationName, self::DEFAULT_APPLICATION_NAME) !== false) {
            throw new InvalidArgumentException(sprintf('Application name is required and cannot be the ' . 'default [%s].', self::DEFAULT_APPLICATION_NAME));
        }
