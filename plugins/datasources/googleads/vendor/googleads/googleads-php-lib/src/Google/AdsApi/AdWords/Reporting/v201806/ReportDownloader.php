...
final class ReportDownloader
{
    ...
    public function __construct(AdWordsSession $session, RequestOptionsFactory $requestOptionsFactory = null, Client $httpClient = null, GuzzleHttpClientFactory $httpClientFactory = null)
    {
        ...
        $this->apiErrorSerializer = new Serializer([new GetSetMethodNormalizer(null, new ApiErrorFieldNameConverter()), new ArrayDenormalizer()], [new XmlEncoder()]);
    }
    /**
    ...
    private function makeReportRequest(array $requestOptions)
    {
        ...
        try {
            ...
            $apiErrorList = AdWordsNormalizer::isOneOrMany($decodedResponse['ApiError']) ? [$decodedResponse['ApiError']] : $decodedResponse['ApiError'];
