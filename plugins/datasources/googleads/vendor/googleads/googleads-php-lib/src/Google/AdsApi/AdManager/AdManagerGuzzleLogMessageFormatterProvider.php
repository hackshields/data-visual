...
final class AdManagerGuzzleLogMessageFormatterProvider implements GuzzleLogMessageFormatterProvider
{
     ...
     */
    public function __construct(AdManagerSession $session, $shouldLogResponsePayload, $redactedResponsePayloadMessage = null)
    {
    ...
    {
        return new GuzzleLogMessageFormatter(self::$HTTP_HEADERS_TO_SCRUB, ['networkCode' => $this->session->getNetworkCode()], $this->shouldLogResponsePayload, $this->redactedResponsePayloadMessage);
    }
}
