...
final class AdManagerDateTimes
{
    ...
    {
        return self::fromDateTime(DateTime::createFromFormat(DateTime::ATOM, $dateTime));
    }
    /**
    ...
    {
        $dateTimeString = sprintf('%sT%02d:%02d:%02d', AdManagerDates::toDateString($adManagerDateTime->getDate()), $adManagerDateTime->getHour(), $adManagerDateTime->getMinute(), $adManagerDateTime->getSecond());
        return new DateTime($dateTimeString, new DateTimeZone($adManagerDateTime->getTimeZoneID()));
    }
    /**
     ...
     * @return string
     */
    public static function toDateTimeString(AdManagerDateTime $adManagerDateTime, $timeZoneId = null)
    {
