...
abstract class BaseRichMediaStudioCreative extends \Google\AdsApi\AdManager\v201808\Creative
{
    ...
    {
        $this->studioCreativeId = !is_null($studioCreativeId) && PHP_INT_SIZE === 4 ? floatval($studioCreativeId) : $studioCreativeId;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->totalFileSize = !is_null($totalFileSize) && PHP_INT_SIZE === 4 ? floatval($totalFileSize) : $totalFileSize;
        return $this;
    }
    /**
     * @return string[]
