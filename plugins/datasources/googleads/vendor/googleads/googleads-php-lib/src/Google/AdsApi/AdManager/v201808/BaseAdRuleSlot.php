...
abstract class BaseAdRuleSlot
{
    ...
    {
        $this->minVideoAdDuration = !is_null($minVideoAdDuration) && PHP_INT_SIZE === 4 ? floatval($minVideoAdDuration) : $minVideoAdDuration;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->maxVideoAdDuration = !is_null($maxVideoAdDuration) && PHP_INT_SIZE === 4 ? floatval($maxVideoAdDuration) : $maxVideoAdDuration;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->maxBumperDuration = !is_null($maxBumperDuration) && PHP_INT_SIZE === 4 ? floatval($maxBumperDuration) : $maxBumperDuration;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->minPodDuration = !is_null($minPodDuration) && PHP_INT_SIZE === 4 ? floatval($minPodDuration) : $minPodDuration;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->maxPodDuration = !is_null($maxPodDuration) && PHP_INT_SIZE === 4 ? floatval($maxPodDuration) : $maxPodDuration;
        return $this;
    }
    /**
     * @return int
