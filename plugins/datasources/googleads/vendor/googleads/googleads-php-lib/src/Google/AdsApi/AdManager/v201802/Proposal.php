...
class Proposal
{
    ...
    {
        $this->dfpOrderId = !is_null($dfpOrderId) && PHP_INT_SIZE === 4 ? floatval($dfpOrderId) : $dfpOrderId;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->probabilityOfClose = !is_null($probabilityOfClose) && PHP_INT_SIZE === 4 ? floatval($probabilityOfClose) : $probabilityOfClose;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->primaryTraffickerId = !is_null($primaryTraffickerId) && PHP_INT_SIZE === 4 ? floatval($primaryTraffickerId) : $primaryTraffickerId;
        return $this;
    }
    /**
     * @return int[]
    ...
    {
        $this->advertiserDiscount = !is_null($advertiserDiscount) && PHP_INT_SIZE === 4 ? floatval($advertiserDiscount) : $advertiserDiscount;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->proposalDiscount = !is_null($proposalDiscount) && PHP_INT_SIZE === 4 ? floatval($proposalDiscount) : $proposalDiscount;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->agencyCommission = !is_null($agencyCommission) && PHP_INT_SIZE === 4 ? floatval($agencyCommission) : $agencyCommission;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->valueAddedTax = !is_null($valueAddedTax) && PHP_INT_SIZE === 4 ? floatval($valueAddedTax) : $valueAddedTax;
        return $this;
    }
    /**
     * @return boolean
