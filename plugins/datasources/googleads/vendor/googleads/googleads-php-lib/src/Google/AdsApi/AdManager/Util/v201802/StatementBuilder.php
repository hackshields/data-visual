...
class StatementBuilder
{
    ...
    public function toStatement()
    {
        ...
        $statement->setValues(MapEntries::fromAssociativeArray($this->getBindVariableMap(), 'Google\\AdsApi\\AdManager\\v201802\\String_ValueMapEntry'));
        return $statement;
    }
    /**
    ...
    private function validateQuery()
    {
        if ($this->offset !== null && $this->limit === null) {
            throw new InvalidArgumentException('OFFSET cannot be set if LIMIT is not set.');
        }
    }
    /**
