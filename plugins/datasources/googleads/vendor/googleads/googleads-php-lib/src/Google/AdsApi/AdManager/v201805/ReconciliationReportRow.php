...
class ReconciliationReportRow
{
    ...
    {
        $this->reconciliationReportId = !is_null($reconciliationReportId) && PHP_INT_SIZE === 4 ? floatval($reconciliationReportId) : $reconciliationReportId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->creativeId = !is_null($creativeId) && PHP_INT_SIZE === 4 ? floatval($creativeId) : $creativeId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->orderId = !is_null($orderId) && PHP_INT_SIZE === 4 ? floatval($orderId) : $orderId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->advertiserId = !is_null($advertiserId) && PHP_INT_SIZE === 4 ? floatval($advertiserId) : $advertiserId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->proposalLineItemId = !is_null($proposalLineItemId) && PHP_INT_SIZE === 4 ? floatval($proposalLineItemId) : $proposalLineItemId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->proposalId = !is_null($proposalId) && PHP_INT_SIZE === 4 ? floatval($proposalId) : $proposalId;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->lineItemContractedUnitsBought = !is_null($lineItemContractedUnitsBought) && PHP_INT_SIZE === 4 ? floatval($lineItemContractedUnitsBought) : $lineItemContractedUnitsBought;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->dfpVolume = !is_null($dfpVolume) && PHP_INT_SIZE === 4 ? floatval($dfpVolume) : $dfpVolume;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->thirdPartyVolume = !is_null($thirdPartyVolume) && PHP_INT_SIZE === 4 ? floatval($thirdPartyVolume) : $thirdPartyVolume;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->manualVolume = !is_null($manualVolume) && PHP_INT_SIZE === 4 ? floatval($manualVolume) : $manualVolume;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->reconciledVolume = !is_null($reconciledVolume) && PHP_INT_SIZE === 4 ? floatval($reconciledVolume) : $reconciledVolume;
        return $this;
    }
    /**
     * @return \Google\AdsApi\AdManager\v201805\Money
