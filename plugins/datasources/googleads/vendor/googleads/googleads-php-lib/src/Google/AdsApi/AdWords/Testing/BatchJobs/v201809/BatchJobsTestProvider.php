...
class BatchJobsTestProvider
{
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'batch-job-mutate-request.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'batch-job-mutate-response.xml');
    }
    /**
    ...
    public static function getMutateResultArray()
    {
        ...
        $campaign = new FakeCampaign();
        $campaign->setId(9.223372036854776E+18);
