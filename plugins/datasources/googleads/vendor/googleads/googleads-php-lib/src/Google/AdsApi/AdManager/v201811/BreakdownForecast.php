...
class BreakdownForecast
{
    ...
    {
        $this->matched = !is_null($matched) && PHP_INT_SIZE === 4 ? floatval($matched) : $matched;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->available = !is_null($available) && PHP_INT_SIZE === 4 ? floatval($available) : $available;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->possible = !is_null($possible) && PHP_INT_SIZE === 4 ? floatval($possible) : $possible;
        return $this;
    }
}
