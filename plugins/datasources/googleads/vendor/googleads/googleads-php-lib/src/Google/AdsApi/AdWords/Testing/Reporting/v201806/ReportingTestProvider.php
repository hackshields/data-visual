...
class ReportingTestProvider
{
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'criteria-report.csv');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'api-report-error.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'report-definition.xml');
    }
}
