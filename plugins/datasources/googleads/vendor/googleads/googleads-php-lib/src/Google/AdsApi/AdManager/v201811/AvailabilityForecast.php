...
class AvailabilityForecast
{
    ...
    {
        $this->availableUnits = !is_null($availableUnits) && PHP_INT_SIZE === 4 ? floatval($availableUnits) : $availableUnits;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->deliveredUnits = !is_null($deliveredUnits) && PHP_INT_SIZE === 4 ? floatval($deliveredUnits) : $deliveredUnits;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->matchedUnits = !is_null($matchedUnits) && PHP_INT_SIZE === 4 ? floatval($matchedUnits) : $matchedUnits;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->possibleUnits = !is_null($possibleUnits) && PHP_INT_SIZE === 4 ? floatval($possibleUnits) : $possibleUnits;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->reservedUnits = !is_null($reservedUnits) && PHP_INT_SIZE === 4 ? floatval($reservedUnits) : $reservedUnits;
        return $this;
    }
    /**
