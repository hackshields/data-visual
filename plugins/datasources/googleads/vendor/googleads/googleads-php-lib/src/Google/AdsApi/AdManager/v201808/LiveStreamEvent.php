...
class LiveStreamEvent
{
    ...
    {
        $this->totalEstimatedConcurrentUsers = !is_null($totalEstimatedConcurrentUsers) && PHP_INT_SIZE === 4 ? floatval($totalEstimatedConcurrentUsers) : $totalEstimatedConcurrentUsers;
        return $this;
    }
    /**
     * @return string[]
    ...
    {
        $this->adHolidayDuration = !is_null($adHolidayDuration) && PHP_INT_SIZE === 4 ? floatval($adHolidayDuration) : $adHolidayDuration;
        return $this;
    }
    /**
     * @return boolean
    ...
    {
        $this->defaultAdBreakDuration = !is_null($defaultAdBreakDuration) && PHP_INT_SIZE === 4 ? floatval($defaultAdBreakDuration) : $defaultAdBreakDuration;
        return $this;
    }
    /**
     * @return int[]
