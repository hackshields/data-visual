...
final class BatchJobsDelegate
{
    ...
    {
        $serializedContent = $this->batchJobSerializer->serialize(['operations' => $operations, '@xmlns:ns1' => 'https://adwords.google.com/api/adwords/cm/v201809', '@xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance'], 'xml');
