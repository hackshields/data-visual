...
class GrpSettings
{
    ...
    {
        $this->minTargetAge = !is_null($minTargetAge) && PHP_INT_SIZE === 4 ? floatval($minTargetAge) : $minTargetAge;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->maxTargetAge = !is_null($maxTargetAge) && PHP_INT_SIZE === 4 ? floatval($maxTargetAge) : $maxTargetAge;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->targetImpressionGoal = !is_null($targetImpressionGoal) && PHP_INT_SIZE === 4 ? floatval($targetImpressionGoal) : $targetImpressionGoal;
        return $this;
    }
}
