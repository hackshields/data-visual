...
class AdWordsNormalizerTestProvider
{
    ...
    {
        return ['budgetId' => -1, 'name' => 'Interplanetary Cruise #57a058e71f2b9'];
    }
    /**
    ...
    {
        return ['budgetId' => 'adwords', 'name' => 'adwords'];
    }
    /**
    ...
    {
        return ['budget_id' => -1, 'name' => 'Interplanetary Cruise #57a058e71f2b9'];
    }
    /**
    ...
    {
        return ['@xsi:type' => 'ns1:FakeMoney', 'microAmount' => 50000000];
    }
    /**
    ...
    {
        return ['@xsi:type' => 'FakeMoney', 'microAmount' => 50000000];
    }
    /**
    ...
    {
        return ['budgetId' => -1, 'name' => 'Test Budget', 'amount' => ['@xsi:type' => 'ns1:FakeMoney', 'microAmount' => 50000000]];
    }
    /**
    ...
    {
        return ['budgetId' => -1, 'name' => 'Test Budget', 'amount' => ['@xsi:type' => 'FakeMoney', 'microAmount' => 50000000]];
    }
    /**
    ...
    {
        return ['budgetId' => -1, 'name' => 'Interplanetary Cruise #57a058e71f2b9', '@attribute' => 'test'];
    }
    /**
    ...
    {
        return ['@xsi:type' => 'ns1:FakeMoney', 'microAmount' => 50000000, 'macroAmount' => 200000000];
    }
    /**
    ...
    {
        return ['@xsi:type' => 'FakeMoney', 'microAmount' => 50000000, 'macroAmount' => 200000000];
    }
    /**
    ...
    {
        return ['result' => ['FakeBudget' => ['budgetId' => 1]]];
    }
    /**
    ...
    {
        return ['result' => [['FakeBudget' => ['budgetId' => 1]], ['FakeBudget' => ['budgetId' => 2]]]];
    }
    /**
    ...
    {
        return ['finalUrls' => ['http://adwords.google.com']];
    }
    /**
    ...
    {
        $ad = new FakeAd();
        $ad->setFinalUrls(['https://adwords.google.com', 'https://mail.google.com', 'https://drive.google.com']);
        return $ad;
    }
    /**
    ...
    {
        return ['finalUrls' => ['https://adwords.google.com', 'https://mail.google.com', 'https://drive.google.com']];
    }
}
