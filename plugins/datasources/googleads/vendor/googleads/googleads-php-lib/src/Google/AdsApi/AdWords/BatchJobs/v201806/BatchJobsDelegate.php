...
final class BatchJobsDelegate
{
    ...
    public function __construct(AdWordsSession $session, Client $httpClient = null, $mutateResultClassName = null, GuzzleHttpClientFactory $httpClientFactory = null)
    {
        ...
        $adWordsNormalizer->setCallbacks(['normalize' => function ($value, $type) {
        ...
        $this->batchJobSerializer = new Serializer([$adWordsNormalizer, new ArrayDenormalizer()], [new XmlEncoder('ns1:mutate')]);
    }
    /**
    ...
    {
        $serializedContent = $this->batchJobSerializer->serialize(['operations' => $operations, '@xmlns:ns1' => 'https://adwords.google.com/api/adwords/cm/v201806', '@xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance'], 'xml');
        ...
        try {
            ...
            $requestOptions[RequestOptions::HEADERS] = ['Content-Length' => $contentLength, 'Content-Range' => $contentRange, 'Content-Type' => 'application/xml'];
    ...
    public function downloadBatchJobResults($downloadUrl)
    {
        ...
        $rval = AdWordsNormalizer::isOneOrMany($mutateResponse['rval']) ? [$mutateResponse['rval']] : $mutateResponse['rval'];
