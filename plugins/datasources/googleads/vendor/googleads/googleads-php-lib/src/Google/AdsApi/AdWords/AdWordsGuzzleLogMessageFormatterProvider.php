...
final class AdWordsGuzzleLogMessageFormatterProvider implements GuzzleLogMessageFormatterProvider
{
    ...
    {
        return new GuzzleLogMessageFormatter(self::$HTTP_HEADERS_TO_SCRUB, ['clientCustomerId' => $this->session->getClientCustomerId()], $this->shouldLogResponsePayload, $this->redactedResponsePayloadMessage);
    }
}
