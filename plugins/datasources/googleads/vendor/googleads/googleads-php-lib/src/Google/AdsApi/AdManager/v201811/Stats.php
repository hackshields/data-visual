...
class Stats
{
    ...
    {
        $this->impressionsDelivered = !is_null($impressionsDelivered) && PHP_INT_SIZE === 4 ? floatval($impressionsDelivered) : $impressionsDelivered;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->clicksDelivered = !is_null($clicksDelivered) && PHP_INT_SIZE === 4 ? floatval($clicksDelivered) : $clicksDelivered;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->videoCompletionsDelivered = !is_null($videoCompletionsDelivered) && PHP_INT_SIZE === 4 ? floatval($videoCompletionsDelivered) : $videoCompletionsDelivered;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->videoStartsDelivered = !is_null($videoStartsDelivered) && PHP_INT_SIZE === 4 ? floatval($videoStartsDelivered) : $videoStartsDelivered;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->viewableImpressionsDelivered = !is_null($viewableImpressionsDelivered) && PHP_INT_SIZE === 4 ? floatval($viewableImpressionsDelivered) : $viewableImpressionsDelivered;
        return $this;
    }
}
