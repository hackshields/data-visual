...
class LineItemSummary
{
    ...
    {
        $this->viewabilityProviderCompanyId = !is_null($viewabilityProviderCompanyId) && PHP_INT_SIZE === 4 ? floatval($viewabilityProviderCompanyId) : $viewabilityProviderCompanyId;
        return $this;
    }
    /**
     * @return string
