...
final class SoapLogMessageFormatter
{
    ...
    {
        $this->requestHttpHeadersToScrub = $requestHttpHeadersToScrub === null ? [] : $requestHttpHeadersToScrub;
        $this->requestSoapHeadersToScrub = $requestSoapHeadersToScrub === null ? [] : $requestSoapHeadersToScrub;
        $this->requestSoapBodyTagsToScrub = $requestSoapBodyTagsToScrub === null ? [] : $requestSoapBodyTagsToScrub;
        $this->additionalRequestSummaryHeaders = $additionalRequestSummaryHeaders === null ? [] : $additionalRequestSummaryHeaders;
        $this->additionalResponseSummaryHeaders = $additionalResponseSummaryHeaders === null ? [] : $additionalResponseSummaryHeaders;
