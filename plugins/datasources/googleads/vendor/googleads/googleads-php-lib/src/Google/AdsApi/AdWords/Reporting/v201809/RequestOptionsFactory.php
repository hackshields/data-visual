...
class RequestOptionsFactory
{
    ...
    public function __construct(AdWordsSession $session, array $options = null, Serializer $reportDefinitionSerializer = null)
    {
        ...
        $this->reportDefinitionSerializer = $reportDefinitionSerializer === null ? new Serializer([new AdWordsNormalizer()], [new XmlEncoder()]) : $reportDefinitionSerializer;
        $this->oAuth2TokenRefresher = new OAuth2TokenRefresher();
        $this->options = $options === null ? ['stream_context' => ['http' => ['timeout' => self::DEFAULT_TIMEOUT_IN_SECONDS]]] : $options;
    ...
    public function createRequestOptionsWithReportDefinition(ReportDefinition $reportDefinition, ReportSettings $reportSettingsOverride = null)
    {
        ...
        return array_merge($this->options, [RequestOptions::HEADERS => $this->createHeaders($reportSettingsOverride), RequestOptions::FORM_PARAMS => $params]);
    }
    /**
