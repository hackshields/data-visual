...
class AudienceSegment
{
    ...
    {
        $this->mobileWebSize = !is_null($mobileWebSize) && PHP_INT_SIZE === 4 ? floatval($mobileWebSize) : $mobileWebSize;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->idfaSize = !is_null($idfaSize) && PHP_INT_SIZE === 4 ? floatval($idfaSize) : $idfaSize;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->adIdSize = !is_null($adIdSize) && PHP_INT_SIZE === 4 ? floatval($adIdSize) : $adIdSize;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->ppidSize = !is_null($ppidSize) && PHP_INT_SIZE === 4 ? floatval($ppidSize) : $ppidSize;
        return $this;
    }
    /**
