...
class ReconciliationLineItemReport
{
    ...
    {
        $this->capVolume = !is_null($capVolume) && PHP_INT_SIZE === 4 ? floatval($capVolume) : $capVolume;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->rolloverVolume = !is_null($rolloverVolume) && PHP_INT_SIZE === 4 ? floatval($rolloverVolume) : $rolloverVolume;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->billableVolume = !is_null($billableVolume) && PHP_INT_SIZE === 4 ? floatval($billableVolume) : $billableVolume;
        return $this;
    }
    /**
     * @return \Google\AdsApi\AdManager\v201805\Money
