...
class AdWordsServicesIntegrationTestProvider
{
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'get-campaigns-response.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'get-campaigns-soapfault.xml');
    }
    /**
    ...
    {
        return file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'get-campaigns-response-validate-only.xml');
    }
}
