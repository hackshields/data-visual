...
class Order
{
    ...
    {
        $this->agencyId = !is_null($agencyId) && PHP_INT_SIZE === 4 ? floatval($agencyId) : $agencyId;
        return $this;
    }
    /**
     * @return int[]
    ...
    {
        $this->creatorId = !is_null($creatorId) && PHP_INT_SIZE === 4 ? floatval($creatorId) : $creatorId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->traffickerId = !is_null($traffickerId) && PHP_INT_SIZE === 4 ? floatval($traffickerId) : $traffickerId;
        return $this;
    }
    /**
     * @return int[]
    ...
    {
        $this->salespersonId = !is_null($salespersonId) && PHP_INT_SIZE === 4 ? floatval($salespersonId) : $salespersonId;
        return $this;
    }
    /**
     * @return int[]
    ...
    {
        $this->totalImpressionsDelivered = !is_null($totalImpressionsDelivered) && PHP_INT_SIZE === 4 ? floatval($totalImpressionsDelivered) : $totalImpressionsDelivered;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->totalClicksDelivered = !is_null($totalClicksDelivered) && PHP_INT_SIZE === 4 ? floatval($totalClicksDelivered) : $totalClicksDelivered;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->totalViewableImpressionsDelivered = !is_null($totalViewableImpressionsDelivered) && PHP_INT_SIZE === 4 ? floatval($totalViewableImpressionsDelivered) : $totalViewableImpressionsDelivered;
        return $this;
    }
    /**
