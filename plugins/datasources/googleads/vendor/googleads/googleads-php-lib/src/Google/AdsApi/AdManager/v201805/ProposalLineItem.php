...
class ProposalLineItem
{
    ...
    {
        $this->packageId = !is_null($packageId) && PHP_INT_SIZE === 4 ? floatval($packageId) : $packageId;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->scheduledQuantity = !is_null($scheduledQuantity) && PHP_INT_SIZE === 4 ? floatval($scheduledQuantity) : $scheduledQuantity;
        return $this;
    }
    /**
     * @return int
    ...
    {
        $this->contractedUnitsBought = !is_null($contractedUnitsBought) && PHP_INT_SIZE === 4 ? floatval($contractedUnitsBought) : $contractedUnitsBought;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->videoMaxDuration = !is_null($videoMaxDuration) && PHP_INT_SIZE === 4 ? floatval($videoMaxDuration) : $videoMaxDuration;
        return $this;
    }
    /**
    ...
    {
        $this->dfpLineItemId = !is_null($dfpLineItemId) && PHP_INT_SIZE === 4 ? floatval($dfpLineItemId) : $dfpLineItemId;
        return $this;
    }
    /**
     * @return string
    ...
    {
        $this->estimatedMinimumImpressions = !is_null($estimatedMinimumImpressions) && PHP_INT_SIZE === 4 ? floatval($estimatedMinimumImpressions) : $estimatedMinimumImpressions;
        return $this;
    }
}
