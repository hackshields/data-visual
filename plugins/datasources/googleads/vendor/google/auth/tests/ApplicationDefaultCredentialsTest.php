...
class ADCGetMiddlewareTest extends TestCase
{
    ...
    public function testWithCacheOptions()
    {
        ...
        $middleware = ApplicationDefaultCredentials::getMiddleware('a scope', $httpHandler, $cacheOptions, $cachePool);
    }
    public function testSuccedsIfNoDefaultFilesButIsOnGCE()
    {
        $wantedTokens = ['access_token' => '1/abdef1234567890', 'expires_in' => '57', 'token_type' => 'Bearer'];
...
class ADCGetCredentialsAppEngineTest extends BaseTest
{
    ...
    public function testAppEngineStandard()
    {
        ...
        $this->assertInstanceOf('Google\\Auth\\Credentials\\AppIdentityCredentials', ApplicationDefaultCredentials::getCredentials());
    }
...
class ADCGetSubscriberTest extends BaseTest
{
    ...
    public function testWithCacheOptions()
    {
        ...
        $cacheOptions = [];
        $cachePool = $this->getMock('Psr\\Cache\\CacheItemPoolInterface');
        $subscriber = ApplicationDefaultCredentials::getSubscriber('a scope', $httpHandler, $cacheOptions, $cachePool);
    }
    public function testSuccedsIfNoDefaultFilesButIsOnGCE()
    {
        $wantedTokens = ['access_token' => '1/abdef1234567890', 'expires_in' => '57', 'token_type' => 'Bearer'];
