...
{
    private $minimal = ['authorizationUri' => 'https://accounts.test.org/insecure/url', 'redirectUri' => 'https://accounts.test.org/redirect/url', 'clientId' => 'aClientID'];
    /**
    ...
    {
        $o = new OAuth2(['authorizationUri' => 'https://accounts.test.org/auth/url', 'redirectUri' => 'https://accounts.test.org/redirect/url']);
    ...
    {
        $o = new OAuth2(['authorizationUri' => 'https://accounts.test.org/auth/url', 'clientId' => 'aClientID']);
        $o->buildFullAuthorizationUri();
    }
    /**
     * @expectedException InvalidArgumentException
    ...
    {
        $o = new OAuth2(['authorizationUri' => 'https://accounts.test.org/auth/url', 'clientId' => 'aClientID']);
        $o->buildFullAuthorizationUri(['approval_prompt' => 'an approval prompt', 'prompt' => 'a prompt']);
    }
    /**
     * @expectedException InvalidArgumentException
     */
    ...
    {
        $o = new OAuth2(['authorizationUri' => 'http://accounts.test.org/insecure/url', 'redirectUri' => 'https://accounts.test.org/redirect/url', 'clientId' => 'aClientID']);
        $o->buildFullAuthorizationUri();
    }
    /**
     * @expectedException InvalidArgumentException
    ...
    {
        $o = new OAuth2(['authorizationUri' => 'http://accounts.test.org/insecure/url', 'redirectUri' => '/redirect/url', 'clientId' => 'aClientID']);
        $o->buildFullAuthorizationUri();
    }
    ...
    {
        $overrides = ['access_type' => 'o_access_type', 'client_id' => 'o_client_id', 'redirect_uri' => 'o_redirect_uri', 'response_type' => 'o_response_type', 'state' => 'o_state'];
    ...
    public function testIncludesTheScope()
    {
        ...
        $with_array = array_merge($this->minimal, ['scope' => ['scope1', 'scope2']]);
    ...
    {
        $o = new OAuth2(['authorizationUri' => 'https://accounts.test.org/insecure/url', 'redirectUri' => 'postmessage', 'clientId' => 'aClientID']);
...
{
    private $minimal = ['clientID' => 'aClientID'];
...
{
    private $signingMinimal = ['signingKey' => 'example_key', 'signingAlgorithm' => 'HS256', 'scope' => 'https://www.googleapis.com/auth/userinfo.profile', 'issuer' => 'app@example.com', 'audience' => 'accounts.google.com', 'clientId' => 'aClientID'];
    /**
...
{
    private $tokenRequestMinimal = ['tokenCredentialUri' => 'https://tokens_r_us/test', 'scope' => 'https://www.googleapis.com/auth/userinfo.profile', 'issuer' => 'app@example.com', 'audience' => 'accounts.google.com', 'clientId' => 'aClientID'];
    /**
     * @expectedException DomainException
     */
...
{
    private $fetchAuthTokenMinimal = ['tokenCredentialUri' => 'https://tokens_r_us/test', 'scope' => 'https://www.googleapis.com/auth/userinfo.profile', 'signingKey' => 'example_key', 'signingAlgorithm' => 'HS256', 'issuer' => 'app@example.com', 'audience' => 'accounts.google.com', 'clientId' => 'aClientID'];
    /**
    ...
    public function testFailsOn400()
    {
        ...
        $httpHandler = getHandler([buildResponse(400)]);
        $o = new OAuth2($testConfig);
    ...
    {
        $testConfig = $this->fetchAuthTokenMinimal;
        $httpHandler = getHandler([buildResponse(500)]);
        $o = new OAuth2($testConfig);
        $o->fetchAuthToken($httpHandler);
    }
    /**
    ...
    public function testFailsOnNoContentTypeIfResponseIsNotJSON()
    {
        ...
        $httpHandler = getHandler([buildResponse(200, [], Psr7\stream_for($notJson))]);
        $o = new OAuth2($testConfig);
        $o->fetchAuthToken($httpHandler);
    }
    ...
    public function testFetchesFromFormEncodedResponseOK()
    {
        ...
        $httpHandler = getHandler([buildResponse(200, ['Content-Type' => 'application/x-www-form-urlencoded'], Psr7\stream_for($json))]);
        $o = new OAuth2($testConfig);
        $tokens = $o->fetchAuthToken($httpHandler);
        $this->assertEquals($tokens['foo'], 'bar');
...
class OAuth2VerifyIdTokenTest extends TestCase
{
    private $publicKey;
    private $privateKey;
    private $verifyIdTokenMinimal = ['scope' => 'https://www.googleapis.com/auth/userinfo.profile', 'audience' => 'myaccount.on.host.issuer.com', 'issuer' => 'an.issuer.com', 'clientId' => 'myaccount.on.host.issuer.com'];
    public function setUp()
    {
        $this->publicKey = file_get_contents(__DIR__ . '/fixtures' . '/public.pem');
        $this->privateKey = file_get_contents(__DIR__ . '/fixtures' . '/private.pem');
    }
    /**
