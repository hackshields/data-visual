...
class FavoriteRequestFields extends AbstractEnum
{
    ...
    {
        return array('api_version' => 'string', 'description' => 'string', 'graph_path' => 'string', 'hash' => 'string', 'http_method' => 'HttpMethod', 'id' => 'string', 'post_params' => 'list<Object>', 'query_params' => 'list<Object>');
    }
}
