...
class AdReportSpecFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'string', 'actions_group_by' => 'list<string>', 'creation_source' => 'string', 'data_columns' => 'list<string>', 'date_preset' => 'string', 'export_columns' => 'list<string>', 'filters' => 'list<Object>', 'format_version' => 'int', 'id' => 'string', 'insights_section' => 'Object', 'name' => 'string', 'report_schedule' => 'Object', 'report_schedule_id' => 'string', 'sort_by' => 'string', 'sort_dir' => 'string', 'time_increment' => 'string', 'time_interval' => 'Object', 'time_ranges' => 'list<Object>', 'format' => 'Format', 'report_run_id' => 'string', 'user_report' => 'bool', 'business_id' => 'string', 'limit' => 'int', 'bypass_async' => 'bool');
    }
}
