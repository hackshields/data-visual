...
class ExtendedCreditFields extends AbstractEnum
{
    ...
    {
        return array('allocated_amount' => 'CurrencyAmount', 'balance' => 'CurrencyAmount', 'credit_available' => 'CurrencyAmount', 'credit_type' => 'string', 'id' => 'string', 'is_access_revoked' => 'bool', 'is_automated_experience' => 'bool', 'last_payment_time' => 'datetime', 'legal_entity_name' => 'string', 'liable_biz_name' => 'string', 'max_balance' => 'CurrencyAmount', 'online_max_balance' => 'CurrencyAmount', 'owner_business' => 'Business', 'owner_business_name' => 'string', 'partition_from' => 'string', 'receiving_credit_allocation_config' => 'ExtendedCreditAllocationConfig', 'send_bill_to_biz_name' => 'string');
    }
}
