...
class AbstractTestCase extends \PHPUnit_Framework_TestCase
{
     ...
     * @param array $data
     */
    protected function makeMockIterable(\PHPUnit_Framework_MockObject_MockObject $mock, array $data = array())
    {
        /** @var Mock $mock */
     ...
     * @param string $fqn
     */
    protected function assertWillThrow(\Closure $closure, $fqn = 'Exception')
    {
        try {
            call_user_func($closure);
        } catch (\Exception $e) {
            $this->assertTrue(is_a($e, $fqn), 'Expected exception of type ' . $fqn . ': ' . get_class($e) . ' received');
            return;
        }
