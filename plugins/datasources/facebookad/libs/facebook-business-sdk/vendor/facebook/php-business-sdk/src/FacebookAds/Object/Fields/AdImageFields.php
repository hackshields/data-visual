...
class AdImageFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'string', 'created_time' => 'datetime', 'creatives' => 'list<string>', 'hash' => 'string', 'height' => 'unsigned int', 'id' => 'string', 'is_associated_creatives_in_adgroups' => 'bool', 'name' => 'string', 'original_height' => 'unsigned int', 'original_width' => 'unsigned int', 'permalink_url' => 'string', 'status' => 'Status', 'updated_time' => 'datetime', 'url' => 'string', 'url_128' => 'string', 'width' => 'unsigned int', 'zipbytes' => 'Object', 'bytes' => 'Object', 'copy_from' => 'Object', 'filename' => 'file');
    }
}
