...
class ProductCatalogFields extends AbstractEnum
{
    ...
    {
        return array('business' => 'Business', 'da_display_settings' => 'ProductCatalogImageSettings', 'default_image_url' => 'string', 'fallback_image_url' => 'list<string>', 'feed_count' => 'int', 'flight_catalog_settings' => 'FlightCatalogSettings', 'id' => 'string', 'name' => 'string', 'product_count' => 'int', 'qualified_product_count' => 'unsigned int', 'vertical' => 'string', 'destination_catalog_settings' => 'map');
    }
}
