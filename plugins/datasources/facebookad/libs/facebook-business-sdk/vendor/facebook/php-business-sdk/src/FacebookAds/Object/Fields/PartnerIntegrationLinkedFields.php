...
class PartnerIntegrationLinkedFields extends AbstractEnum
{
    ...
    {
        return array('ads_pixel' => 'AdsPixel', 'application' => 'Application', 'completed_integration_types' => 'list<string>', 'external_id' => 'string', 'has_oauth_token' => 'bool', 'id' => 'string', 'name' => 'string', 'offline_conversion_data_set' => 'OfflineConversionDataSet', 'partner' => 'string', 'partner_profile' => 'Object', 'product_catalog' => 'ProductCatalog', 'setup_status' => 'string', 'gtm_account_id' => 'string', 'gtm_container_id' => 'string');
    }
}
