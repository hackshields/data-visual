...
class CustomAudienceFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'string', 'approximate_count' => 'int', 'customer_file_source' => 'string', 'data_source' => 'CustomAudienceDataSource', 'data_source_types' => 'string', 'datafile_custom_audience_uploading_status' => 'string', 'delivery_status' => 'CustomAudienceStatus', 'description' => 'string', 'excluded_custom_audiences' => 'list<CustomAudience>', 'expiry_time' => 'unsigned int', 'external_event_source' => 'AdsPixel', 'household_audience' => 'int', 'id' => 'string', 'included_custom_audiences' => 'list<CustomAudience>', 'is_household' => 'bool', 'is_snapshot' => 'bool', 'is_value_based' => 'bool', 'list_of_accounts' => 'list<string>', 'lookalike_audience_ids' => 'list<string>', 'lookalike_spec' => 'LookalikeSpec', 'name' => 'string', 'operation_status' => 'CustomAudienceStatus', 'opt_out_link' => 'string', 'permission_for_actions' => 'AudiencePermissionForActions', 'pixel_id' => 'string', 'retention_days' => 'int', 'rev_share_policy_id' => 'unsigned int', 'rule' => 'string', 'rule_aggregation' => 'string', 'rule_v2' => 'string', 'seed_audience' => 'int', 'sharing_status' => 'CustomAudienceSharingStatus', 'study_spec' => 'AudienceInsightsStudySpec', 'subtype' => 'string', 'time_content_updated' => 'unsigned int', 'time_created' => 'unsigned int', 'time_updated' => 'unsigned int', 'creation_params' => 'map', 'parent_audience_id' => 'unsigned int', 'tags' => 'list<string>', 'associated_audience_id' => 'unsigned int', 'is_household_exclusion' => 'bool', 'allowed_domains' => 'list<string>', 'partner_reference_key' => 'string', 'prefill' => 'bool', 'inclusions' => 'list<Object>', 'exclusions' => 'list<Object>', 'countries' => 'string', 'origin_audience_id' => 'string', 'details' => 'string', 'source' => 'string', 'isPrivate' => 'bool', 'additionalMetadata' => 'string', 'minAge' => 'unsigned int', 'maxAge' => 'unsigned int', 'expectedSize' => 'unsigned int', 'gender' => 'string', 'partnerID' => 'string', 'accountID' => 'string', 'claim_objective' => 'ClaimObjective', 'content_type' => 'ContentType', 'event_source_group' => 'string', 'product_set_id' => 'string', 'event_sources' => 'list<map>', 'video_group_ids' => 'list<string>', 'dataset_id' => 'string');
    }
}
