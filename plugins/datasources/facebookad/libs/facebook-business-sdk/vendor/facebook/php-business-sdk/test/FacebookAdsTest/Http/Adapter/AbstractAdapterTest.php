...
abstract class AbstractAdapterTest extends AbstractUnitTestCase
{
     ...
     */
    protected abstract function createAdapter($client = null);
    public function testGetters()
    {
        $client = new Client();
        $adapter = $this->createAdapter($client);
        $this->assertTrue($client === $adapter->getClient());
        $this->assertEquals($client->getCaBundlePath(), $adapter->getCaBundlePath());
    }
    ...
    public abstract function testRequest();
}
