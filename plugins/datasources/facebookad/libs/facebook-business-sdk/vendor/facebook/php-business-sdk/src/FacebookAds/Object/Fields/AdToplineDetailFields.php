...
class AdToplineDetailFields extends AbstractEnum
{
    ...
    {
        return array('active_status' => 'int', 'ad_account_id' => 'string', 'flight_end_date' => 'datetime', 'flight_start_date' => 'datetime', 'id' => 'string', 'io_number' => 'int', 'line_number' => 'int', 'price' => 'float', 'quantity' => 'float', 'sf_detail_line_id' => 'string', 'subline_id' => 'string', 'targets' => 'string', 'time_created' => 'datetime', 'time_updated' => 'datetime', 'topline_id' => 'AdTopline');
    }
}
