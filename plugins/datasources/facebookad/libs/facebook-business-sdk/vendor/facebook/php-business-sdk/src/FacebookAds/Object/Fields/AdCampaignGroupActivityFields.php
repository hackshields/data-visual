...
class AdCampaignGroupActivityFields extends AbstractEnum
{
    ...
    {
        return array('budget_limit_new' => 'Object', 'budget_limit_old' => 'Object', 'buying_type_new' => 'string', 'buying_type_old' => 'string', 'event_time' => 'datetime', 'event_type' => 'string', 'id' => 'string', 'is_autobid_new' => 'bool', 'is_autobid_old' => 'bool', 'is_average_price_pacing_new' => 'bool', 'is_average_price_pacing_old' => 'bool', 'name_new' => 'string', 'name_old' => 'string', 'objective_new' => 'ObjectiveNew', 'objective_old' => 'ObjectiveOld', 'pacing_type' => 'int', 'run_status_new' => 'string', 'run_status_old' => 'string', 'spend_cap_new' => 'int', 'spend_cap_old' => 'int', 'time_created' => 'datetime', 'time_updated_new' => 'datetime', 'time_updated_old' => 'datetime');
    }
}
