...
class ExpirablePostFields extends AbstractEnum
{
    ...
    {
        return array('admin_creator' => 'User', 'can_republish' => 'bool', 'content_type' => 'string', 'creation_time' => 'datetime', 'expiration' => 'Object', 'feed_audience_description' => 'string', 'feed_targeting' => 'Targeting', 'id' => 'string', 'message' => 'string', 'modified_time' => 'datetime', 'og_action_summary' => 'string', 'permalink_url' => 'string', 'place' => 'Place', 'privacy_description' => 'string', 'promotion_info' => 'Object', 'scheduled_publish_time' => 'datetime', 'story_token' => 'string', 'thumbnail' => 'string', 'video_id' => 'string');
    }
}
