...
class TargetingGeoLocationCustomLocationFields extends AbstractEnum
{
    ...
    {
        return array('address_string' => 'string', 'country' => 'string', 'country_group' => 'string', 'custom_type' => 'string', 'distance_unit' => 'string', 'key' => 'string', 'latitude' => 'float', 'longitude' => 'float', 'max_population' => 'int', 'min_population' => 'int', 'name' => 'string', 'primary_city_id' => 'int', 'radius' => 'float', 'region_id' => 'int', 'id' => 'string');
    }
}
