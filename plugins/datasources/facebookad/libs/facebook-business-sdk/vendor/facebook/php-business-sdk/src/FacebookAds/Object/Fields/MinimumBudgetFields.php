...
class MinimumBudgetFields extends AbstractEnum
{
    ...
    {
        return array('currency' => 'string', 'min_daily_budget_high_freq' => 'int', 'min_daily_budget_imp' => 'int', 'min_daily_budget_low_freq' => 'int', 'min_daily_budget_video_views' => 'int', 'id' => 'string');
    }
}
