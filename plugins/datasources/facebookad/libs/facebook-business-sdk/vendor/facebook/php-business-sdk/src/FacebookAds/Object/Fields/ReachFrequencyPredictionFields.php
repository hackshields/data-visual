...
class ReachFrequencyPredictionFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'int', 'activity_status' => 'ReachFrequencyActivity', 'ad_formats' => 'list<ReachFrequencyAdFormat>', 'auction_entry_option_index' => 'int', 'business_id' => 'int', 'buying_type' => 'string', 'campaign_group_id' => 'int', 'campaign_id' => 'string', 'campaign_time_start' => 'datetime', 'campaign_time_stop' => 'datetime', 'currency' => 'string', 'curve_budget_reach' => 'ReachFrequencyEstimatesCurve', 'curve_reach' => 'list<unsigned int>', 'daily_grp_curve' => 'list<float>', 'daily_impression_curve' => 'list<float>', 'daily_impression_curve_map' => 'list<Object>', 'day_parting_schedule' => 'list<ReachFrequencyDayPart>', 'demo_breakdown' => 'ReachFrequencyEstimatesDemoBreakdown', 'destination_id' => 'string', 'end_time' => 'datetime', 'expiration_time' => 'datetime', 'external_budget' => 'int', 'external_impression' => 'unsigned int', 'external_maximum_budget' => 'int', 'external_maximum_impression' => 'string', 'external_maximum_reach' => 'unsigned int', 'external_minimum_budget' => 'int', 'external_minimum_impression' => 'unsigned int', 'external_minimum_reach' => 'unsigned int', 'external_reach' => 'unsigned int', 'external_values_breakdown' => 'string', 'feed_ratio_0000' => 'unsigned int', 'frequency_cap' => 'unsigned int', 'frequency_distribution' => 'list<float>', 'frequency_distribution_map' => 'list<Object>', 'frequency_distribution_map_agg' => 'list<Object>', 'full_view_ratio_00' => 'unsigned int', 'grp_audience_size' => 'float', 'grp_avg_probability_map' => 'string', 'grp_country_audience_size' => 'float', 'grp_curve' => 'list<float>', 'grp_dmas_audience_size' => 'float', 'grp_filtering_threshold_00' => 'unsigned int', 'grp_points' => 'float', 'grp_ratio' => 'float', 'grp_reach_ratio' => 'float', 'grp_status' => 'string', 'holdout_percentage' => 'unsigned int', 'id' => 'string', 'impression_curve' => 'list<unsigned int>', 'instagram_destination_id' => 'string', 'instream_packages' => 'list<string>', 'interval_frequency_cap' => 'unsigned int', 'interval_frequency_cap_reset_period' => 'unsigned int', 'is_bonus_media' => 'unsigned int', 'is_conversion_goal' => 'unsigned int', 'is_higher_average_frequency' => 'bool', 'is_io' => 'bool', 'is_reserved_buying' => 'unsigned int', 'is_trp' => 'bool', 'name' => 'string', 'objective' => 'unsigned int', 'objective_name' => 'string', 'pause_periods' => 'list<Object>', 'placement_breakdown' => 'ReachFrequencyEstimatesPlacementBreakdown', 'placement_breakdown_map' => 'list<Object>', 'plan_name' => 'string', 'plan_type' => 'string', 'prediction_mode' => 'unsigned int', 'prediction_progress' => 'unsigned int', 'reference_id' => 'string', 'reservation_status' => 'unsigned int', 'start_time' => 'datetime', 'status' => 'unsigned int', 'story_event_type' => 'unsigned int', 'target_audience_size' => 'unsigned int', 'target_cpm' => 'unsigned int', 'target_spec' => 'Targeting', 'time_created' => 'datetime', 'time_updated' => 'datetime', 'timezone_id' => 'unsigned int', 'timezone_name' => 'string', 'topline_id' => 'unsigned int', 'tv_viewer_cluster_map' => 'list<Object>', 'video_view_benchmark_map' => 'list<Object>', 'video_view_length_constraint' => 'unsigned int', 'viewtag' => 'string', 'action' => 'Action', 'stop_time' => 'unsigned int', 'reach' => 'unsigned int', 'impression' => 'unsigned int', 'budget' => 'unsigned int', 'destination_ids' => 'list<string>', 'rf_prediction_id' => 'string', 'rf_prediction_id_to_release' => 'string', 'rf_prediction_id_to_share' => 'string', 'num_curve_points' => 'unsigned int', 'grp_buying' => 'bool', 'is_full_view' => 'bool', 'is_reach_and_frequency_io_buying' => 'bool', 'existing_campaign_id' => 'string', 'exceptions' => 'bool');
    }
}
