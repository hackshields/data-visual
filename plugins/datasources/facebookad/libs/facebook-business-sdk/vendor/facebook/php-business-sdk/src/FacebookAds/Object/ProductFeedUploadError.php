...
class ProductFeedUploadError extends AbstractCrudObject
{
    ...
    public function getSamples(array $fields = array(), array $params = array(), $pending = false)
    {
        ...
        $param_types = array();
        $enums = array();
        $request = new ApiRequest($this->api, $this->data['id'], RequestInterface::METHOD_GET, '/samples', new ProductFeedUploadErrorSample(), 'EDGE', ProductFeedUploadErrorSample::getFieldsEnum()->getValues(), new TypeChecker($param_types, $enums));
    ...
    public function getSuggestedRules(array $fields = array(), array $params = array(), $pending = false)
    {
        ...
        $param_types = array();
        $enums = array();
        $request = new ApiRequest($this->api, $this->data['id'], RequestInterface::METHOD_GET, '/suggested_rules', new ProductFeedRuleSuggestion(), 'EDGE', ProductFeedRuleSuggestion::getFieldsEnum()->getValues(), new TypeChecker($param_types, $enums));
        $request->addParams($params);
        $request->addFields($fields);
        return $pending ? $request : $request->execute();
    }
    public function getSelf(array $fields = array(), array $params = array(), $pending = false)
    {
        ...
        $param_types = array();
        $enums = array();
        $request = new ApiRequest($this->api, $this->data['id'], RequestInterface::METHOD_GET, '/', new ProductFeedUploadError(), 'NODE', ProductFeedUploadError::getFieldsEnum()->getValues(), new TypeChecker($param_types, $enums));
        $request->addParams($params);
        $request->addFields($fields);
        return $pending ? $request : $request->execute();
    }
