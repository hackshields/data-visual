...
class CurlAdapterTest extends AbstractAdapterTest
{
    ...
    {
        parent::testGetters();
        $this->assertTrue($this->createAdapter()->getCurl() instanceof CurlInterface);
    }
    public function testRequest()
    {
        ...
        $this->makeMockIterable($headers, array('X-custom-header' => 'header value'));
        $query = $this->createParametersMock(array('param' => 'value'));
        // HTTP_GET
        ...
        $body = $this->createParametersMock();
        $this->makeMockIterable($body, array('file' => './filepath'));
        $files = $this->createParametersMock();
        $this->makeMockIterable($files, array('field' => 'value'));
        $request = $this->createRequestMock();
