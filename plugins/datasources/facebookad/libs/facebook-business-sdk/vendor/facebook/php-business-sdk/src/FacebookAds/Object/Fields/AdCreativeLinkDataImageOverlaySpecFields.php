...
class AdCreativeLinkDataImageOverlaySpecFields extends AbstractEnum
{
    ...
    {
        return array('custom_text_type' => 'CustomTextType', 'float_with_margin' => 'bool', 'overlay_template' => 'OverlayTemplate', 'position' => 'Position', 'text_font' => 'TextFont', 'text_template_tags' => 'list<string>', 'text_type' => 'TextType', 'theme_color' => 'ThemeColor', 'id' => 'string');
    }
}
