...
class CopyrightAttributionInsightsFields extends AbstractEnum
{
    ...
    {
        return array('l7_attribution_page_view' => 'int', 'l7_attribution_page_view_delta' => 'float', 'l7_attribution_video_view' => 'int', 'l7_attribution_video_view_delta' => 'float', 'metrics_ending_date' => 'string', 'id' => 'string');
    }
}
