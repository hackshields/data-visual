...
class TargetingDynamicRuleFields extends AbstractEnum
{
    ...
    {
        return array('action.type' => 'string', 'ad_group_id' => 'string', 'campaign_group_id' => 'string', 'campaign_id' => 'string', 'impression_count' => 'string', 'page_id' => 'string', 'post' => 'string', 'retention_seconds' => 'string', 'id' => 'string');
    }
}
