...
class RecommendationFields extends AbstractEnum
{
    ...
    {
        return array('created_time' => 'datetime', 'has_rating' => 'bool', 'has_review' => 'bool', 'open_graph_story' => 'Object', 'rating' => 'int', 'recommendation_type' => 'string', 'review_text' => 'string', 'reviewer' => 'User', 'id' => 'string');
    }
}
