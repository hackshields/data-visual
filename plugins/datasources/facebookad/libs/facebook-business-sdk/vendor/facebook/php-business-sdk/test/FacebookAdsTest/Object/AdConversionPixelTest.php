...
class AdConversionPixelTest extends AbstractCrudObjectTestCase
{
    ...
    {
        $conversionPixel = new AdConversionPixel(null, $this->getConfig()->accountId);
        $conversionPixel->{AdConversionPixelFields::NAME} = $this->getConfig()->testRunId;
        ...
        $this->assertCanUpdate($conversionPixel, array(AdConversionPixelFields::TAG => 'add_to_cart'));
