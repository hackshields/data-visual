...
class LeadgenFormFields extends AbstractEnum
{
    ...
    {
        return array('allow_organic_lead' => 'bool', 'block_display_for_non_targeted_viewer' => 'bool', 'context_card' => 'LeadGenContextCard', 'created_time' => 'datetime', 'creator' => 'User', 'creator_id' => 'int', 'cusomized_tcpa_content' => 'string', 'expired_leads_count' => 'unsigned int', 'extra_details' => 'list<string>', 'follow_up_action_text' => 'string', 'follow_up_action_url' => 'string', 'id' => 'string', 'is_optimized_for_quality' => 'bool', 'leadgen_export_csv_url' => 'string', 'leads_count' => 'unsigned int', 'legal_content' => 'LeadGenLegalContent', 'locale' => 'string', 'messenger_welcome_message' => 'string', 'name' => 'string', 'organic_leads_count' => 'unsigned int', 'page' => 'Page', 'page_id' => 'string', 'privacy_policy_url' => 'string', 'qualifiers' => 'list<LeadGenQualifier>', 'question_page_custom_headline' => 'string', 'questions' => 'list<LeadGenQuestion>', 'status' => 'string', 'tcpa_compliance' => 'bool', 'thank_you_page' => 'Object', 'tracking_parameters' => 'list<Object>');
    }
}
