...
class DirectDealFields extends AbstractEnum
{
    ...
    {
        return array('adbreaks_enabled' => 'bool', 'adset' => 'AdSet', 'advertiser' => 'Object', 'advertiser_lead_email' => 'string', 'advertiser_page' => 'string', 'cpe_amount' => 'int', 'cpe_currency' => 'string', 'end_time' => 'int', 'id' => 'string', 'lifetime_budget_amount' => 'int', 'lifetime_budget_currency' => 'string', 'lifetime_impressions' => 'int', 'name' => 'string', 'pages' => 'list<string>', 'placements' => 'list<string>', 'priced_by' => 'string', 'publisher_name' => 'string', 'review_requirement' => 'string', 'sales_lead_email' => 'string', 'start_time' => 'int', 'status' => 'string', 'targeting' => 'Targeting', 'third_party_ids' => 'list<string>', 'third_party_integrated_deal' => 'bool');
    }
}
