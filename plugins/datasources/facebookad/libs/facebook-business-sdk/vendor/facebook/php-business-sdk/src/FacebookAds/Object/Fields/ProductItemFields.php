...
class ProductItemFields extends AbstractEnum
{
    ...
    {
        return array('additional_image_cdn_urls' => 'list<list<Object>>', 'additional_image_urls' => 'list<string>', 'additional_variant_attributes' => 'list<Object>', 'age_group' => 'AgeGroup', 'applinks' => 'AppLinks', 'availability' => 'Availability', 'brand' => 'string', 'capability_to_review_status' => 'list<Object>', 'category' => 'string', 'color' => 'string', 'commerce_insights' => 'ProductItemCommerceInsights', 'condition' => 'Condition', 'currency' => 'string', 'custom_data' => 'list<Object>', 'custom_label_0' => 'string', 'custom_label_1' => 'string', 'custom_label_2' => 'string', 'custom_label_3' => 'string', 'custom_label_4' => 'string', 'description' => 'string', 'expiration_date' => 'string', 'gender' => 'Gender', 'gtin' => 'string', 'id' => 'string', 'image_cdn_urls' => 'list<Object>', 'image_url' => 'string', 'inventory' => 'int', 'manufacturer_part_number' => 'string', 'material' => 'string', 'mobile_link' => 'string', 'name' => 'string', 'ordering_index' => 'int', 'pattern' => 'string', 'price' => 'string', 'product_catalog' => 'ProductCatalog', 'product_feed' => 'ProductFeed', 'product_group' => 'ProductGroup', 'product_type' => 'string', 'retailer_id' => 'string', 'retailer_product_group_id' => 'string', 'review_rejection_reasons' => 'list<string>', 'review_status' => 'ReviewStatus', 'sale_price' => 'string', 'sale_price_end_date' => 'string', 'sale_price_start_date' => 'string', 'shipping_weight_unit' => 'ShippingWeightUnit', 'shipping_weight_value' => 'float', 'short_description' => 'string', 'size' => 'string', 'start_date' => 'string', 'url' => 'string', 'visibility' => 'Visibility', 'checkout_url' => 'string', 'offer_price_amount' => 'unsigned int', 'offer_price_end_date' => 'Object', 'offer_price_start_date' => 'Object', 'ios_url' => 'string', 'ios_app_store_id' => 'unsigned int', 'ios_app_name' => 'string', 'iphone_url' => 'string', 'iphone_app_store_id' => 'unsigned int', 'iphone_app_name' => 'string', 'ipad_url' => 'string', 'ipad_app_store_id' => 'unsigned int', 'ipad_app_name' => 'string', 'android_url' => 'string', 'android_package' => 'string', 'android_class' => 'string', 'android_app_name' => 'string', 'windows_phone_url' => 'string', 'windows_phone_app_id' => 'string', 'windows_phone_app_name' => 'string');
    }
}
