...
class ProductEventStatFields extends AbstractEnum
{
    ...
    {
        return array('date_start' => 'string', 'date_stop' => 'string', 'device_type' => 'DeviceType', 'event' => 'Event', 'event_source' => 'ExternalEventSource', 'total_content_ids_matched_other_catalogs' => 'int', 'total_matched_content_ids' => 'int', 'total_unmatched_content_ids' => 'int', 'unique_content_ids_matched_other_catalogs' => 'int', 'unique_matched_content_ids' => 'int', 'unique_unmatched_content_ids' => 'int', 'id' => 'string');
    }
}
