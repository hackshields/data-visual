...
class AdAccountActivityFields extends AbstractEnum
{
    ...
    {
        return array('billing_address_new' => 'string', 'billing_address_old' => 'string', 'created_by' => 'string', 'created_time' => 'datetime', 'credit_new' => 'Object', 'credit_old' => 'Object', 'credit_status_new' => 'string', 'credit_status_old' => 'string', 'currency_new' => 'string', 'currency_old' => 'string', 'daily_spend_limit_new' => 'Object', 'daily_spend_limit_old' => 'Object', 'event_time' => 'datetime', 'event_type' => 'string', 'funding_id_new' => 'string', 'funding_id_old' => 'string', 'grace_period_time_new' => 'int', 'grace_period_time_old' => 'int', 'id' => 'string', 'manager_id_new' => 'string', 'manager_id_old' => 'string', 'name_new' => 'string', 'name_old' => 'string', 'spend_cap_new' => 'Object', 'spend_cap_old' => 'Object', 'status_new' => 'string', 'status_old' => 'string', 'terms_new' => 'int', 'terms_old' => 'int', 'tier_new' => 'string', 'tier_old' => 'string', 'time_updated_new' => 'datetime', 'time_updated_old' => 'datetime');
    }
}
