...
class AdCreativeVideoDataFields extends AbstractEnum
{
    ...
    {
        return array('additional_image_index' => 'int', 'branded_content_shared_to_sponsor_status' => 'string', 'branded_content_sponsor_page_id' => 'string', 'branded_content_sponsor_relationship' => 'string', 'call_to_action' => 'AdCreativeLinkDataCallToAction', 'collection_thumbnails' => 'list<AdCreativeCollectionThumbnailInfo>', 'custom_overlay_spec' => 'list<AdCreativeVideoDataCustomOverlaySpec>', 'image_hash' => 'string', 'image_url' => 'string', 'link_description' => 'string', 'message' => 'string', 'offer_id' => 'string', 'page_welcome_message' => 'string', 'post_click_configuration' => 'AdCreativePostClickConfiguration', 'retailer_item_ids' => 'list<string>', 'targeting' => 'Targeting', 'title' => 'string', 'video_id' => 'string', 'id' => 'string');
    }
}
