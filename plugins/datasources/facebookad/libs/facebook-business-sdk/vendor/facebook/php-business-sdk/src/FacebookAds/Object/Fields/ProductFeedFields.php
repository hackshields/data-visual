...
class ProductFeedFields extends AbstractEnum
{
    ...
    {
        return array('country' => 'string', 'created_time' => 'datetime', 'default_currency' => 'string', 'deletion_enabled' => 'bool', 'delimiter' => 'Delimiter', 'encoding' => 'string', 'file_name' => 'string', 'id' => 'string', 'latest_upload' => 'ProductFeedUpload', 'name' => 'string', 'override_type' => 'string', 'product_count' => 'int', 'qualified_product_count' => 'unsigned int', 'quoted_fields_mode' => 'QuotedFieldsMode', 'schedule' => 'ProductFeedSchedule', 'update_schedule' => 'ProductFeedSchedule', 'feed_type' => 'FeedType', 'quoted_fields' => 'bool', 'rules' => 'list<string>');
    }
}
