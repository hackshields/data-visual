...
class CanvasAdSettingsFields extends AbstractEnum
{
    ...
    {
        return array('is_canvas_collection_eligible' => 'bool', 'lead_form_created_time' => 'Object', 'lead_form_name' => 'string', 'lead_gen_form_id' => 'string', 'leads_count' => 'int', 'product_set_id' => 'string', 'use_retailer_item_ids' => 'bool', 'id' => 'string');
    }
}
