...
trait AdLabelAwareCrudObjectTrait
{
    ...
    {
        $this->getApi()->call('/' . $this->assureId() . '/adlabels', RequestInterface::METHOD_POST, $this->formatParams($ad_label_ids));
    }
    /**
    ...
    {
        $this->getApi()->call('/' . $this->assureId() . '/adlabels', RequestInterface::METHOD_DELETE, $this->formatParams($ad_label_ids));
    }
}
