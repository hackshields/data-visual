...
class AdCreativeLinkDataCallToActionValueFields extends AbstractEnum
{
    ...
    {
        return array('app_destination' => 'string', 'app_link' => 'string', 'application' => 'string', 'event_id' => 'string', 'lead_gen_form_id' => 'string', 'link' => 'string', 'link_caption' => 'string', 'link_format' => 'string', 'page' => 'string', 'product_link' => 'string', 'whatsapp_number' => 'string', 'id' => 'string');
    }
}
