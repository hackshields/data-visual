...
class AdReportRunFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'string', 'async_percent_completion' => 'unsigned int', 'async_status' => 'string', 'date_start' => 'string', 'date_stop' => 'string', 'emails' => 'list<string>', 'friendly_name' => 'string', 'id' => 'string', 'is_bookmarked' => 'bool', 'is_running' => 'bool', 'schedule_id' => 'string', 'time_completed' => 'unsigned int', 'time_ref' => 'unsigned int', 'default_summary' => 'bool', 'fields' => 'list<string>', 'filtering' => 'list<Object>', 'summary' => 'list<string>', 'sort' => 'list<string>', 'action_attribution_windows' => 'list<ActionAttributionWindows>', 'action_breakdowns' => 'list<ActionBreakdowns>', 'action_report_time' => 'ActionReportTime', 'breakdowns' => 'list<Breakdowns>', 'date_preset' => 'DatePreset', 'export_columns' => 'list<string>', 'export_format' => 'string', 'export_name' => 'string', 'level' => 'Level', 'product_id_limit' => 'int', 'summary_action_breakdowns' => 'list<SummaryActionBreakdowns>', 'time_increment' => 'string', 'time_range' => 'Object', 'time_ranges' => 'list<Object>', 'use_account_attribution_setting' => 'bool');
    }
}
