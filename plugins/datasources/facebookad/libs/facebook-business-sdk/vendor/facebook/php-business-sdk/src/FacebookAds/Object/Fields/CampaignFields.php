...
class CampaignFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'string', 'adlabels' => 'list<AdLabel>', 'bid_strategy' => 'BidStrategy', 'boosted_object_id' => 'string', 'brand_lift_studies' => 'list<AdStudy>', 'budget_rebalance_flag' => 'bool', 'budget_remaining' => 'string', 'buying_type' => 'string', 'can_create_brand_lift_study' => 'bool', 'can_use_spend_cap' => 'bool', 'configured_status' => 'ConfiguredStatus', 'created_time' => 'datetime', 'daily_budget' => 'string', 'effective_status' => 'EffectiveStatus', 'id' => 'string', 'last_budget_toggling_time' => 'datetime', 'lifetime_budget' => 'string', 'metrics_metadata' => 'AdCampaignGroupMetricsMetadata', 'name' => 'string', 'objective' => 'string', 'pacing_type' => 'list<string>', 'promoted_object' => 'AdPromotedObject', 'recommendations' => 'list<AdRecommendation>', 'source_campaign' => 'Campaign', 'source_campaign_id' => 'string', 'spend_cap' => 'string', 'start_time' => 'datetime', 'status' => 'Status', 'stop_time' => 'datetime', 'topline_id' => 'string', 'updated_time' => 'datetime', 'adbatch' => 'list<Object>', 'execution_options' => 'list<ExecutionOptions>', 'upstream_events' => 'map', 'iterative_split_test_configs' => 'list<Object>', 'kpi_custom_conversion_id' => 'string', 'kpi_type' => 'Object', 'is_autobid' => 'bool', 'is_average_price_pacing' => 'bool');
    }
}
