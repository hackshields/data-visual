...
class AdsInsightsFields extends AbstractEnum
{
    ...
    {
        return array('account_currency' => 'string', 'account_id' => 'string', 'account_name' => 'string', 'action_values' => 'list<AdsActionStats>', 'actions' => 'list<AdsActionStats>', 'activity_recency' => 'string', 'ad_click_actions' => 'list<AdsActionStats>', 'ad_format_asset' => 'string', 'ad_id' => 'string', 'ad_impression_actions' => 'list<AdsActionStats>', 'ad_name' => 'string', 'adset_id' => 'string', 'adset_name' => 'string', 'age' => 'string', 'age_targeting' => 'string', 'auction_bid' => 'string', 'auction_competitiveness' => 'string', 'auction_max_competitor_bid' => 'string', 'bid_type' => 'string', 'body_asset' => 'Object', 'buying_type' => 'string', 'call_to_action_asset' => 'Object', 'campaign_id' => 'string', 'campaign_name' => 'string', 'canvas_avg_view_percent' => 'string', 'canvas_avg_view_time' => 'string', 'clicks' => 'string', 'conversion_values' => 'list<AdsActionStats>', 'conversions' => 'list<AdsActionStats>', 'cost_per_10_sec_video_view' => 'list<AdsActionStats>', 'cost_per_15_sec_video_view' => 'list<AdsActionStats>', 'cost_per_2_sec_continuous_video_view' => 'list<AdsActionStats>', 'cost_per_action_type' => 'list<AdsActionStats>', 'cost_per_ad_click' => 'list<AdsActionStats>', 'cost_per_conversion' => 'list<AdsActionStats>', 'cost_per_dda_countby_convs' => 'string', 'cost_per_estimated_ad_recallers' => 'string', 'cost_per_inline_link_click' => 'string', 'cost_per_inline_post_engagement' => 'string', 'cost_per_one_thousand_ad_impression' => 'list<AdsActionStats>', 'cost_per_outbound_click' => 'list<AdsActionStats>', 'cost_per_thruplay' => 'list<AdsActionStats>', 'cost_per_unique_action_type' => 'list<AdsActionStats>', 'cost_per_unique_click' => 'string', 'cost_per_unique_conversion' => 'list<AdsActionStats>', 'cost_per_unique_inline_link_click' => 'string', 'cost_per_unique_outbound_click' => 'list<AdsActionStats>', 'country' => 'string', 'cpc' => 'string', 'cpm' => 'string', 'cpp' => 'string', 'created_time' => 'string', 'creative_fingerprint' => 'string', 'ctr' => 'string', 'date_start' => 'string', 'date_stop' => 'string', 'dda_countby_convs' => 'string', 'description_asset' => 'Object', 'device_platform' => 'string', 'dma' => 'string', 'estimated_ad_recall_rate' => 'string', 'estimated_ad_recall_rate_lower_bound' => 'string', 'estimated_ad_recall_rate_upper_bound' => 'string', 'estimated_ad_recallers' => 'string', 'estimated_ad_recallers_lower_bound' => 'string', 'estimated_ad_recallers_upper_bound' => 'string', 'frequency' => 'string', 'frequency_value' => 'string', 'gender' => 'string', 'gender_targeting' => 'string', 'hourly_stats_aggregated_by_advertiser_time_zone' => 'string', 'hourly_stats_aggregated_by_audience_time_zone' => 'string', 'image_asset' => 'Object', 'impression_device' => 'string', 'impressions' => 'string', 'impressions_dummy' => 'string', 'inline_link_click_ctr' => 'string', 'inline_link_clicks' => 'string', 'inline_post_engagement' => 'string', 'labels' => 'string', 'link_url_asset' => 'Object', 'location' => 'string', 'media_asset' => 'Object', 'mobile_app_purchase_roas' => 'list<AdsActionStats>', 'objective' => 'string', 'outbound_clicks' => 'list<AdsActionStats>', 'outbound_clicks_ctr' => 'list<AdsActionStats>', 'place_page_id' => 'string', 'place_page_name' => 'string', 'placement' => 'string', 'platform_position' => 'string', 'product_format' => 'string', 'product_id' => 'string', 'publisher_platform' => 'string', 'purchase_roas' => 'list<AdsActionStats>', 'purchasing_interface' => 'string', 'reach' => 'string', 'region' => 'string', 'relevance_score' => 'AdgroupRelevanceScore', 'rule_asset' => 'Object', 'social_spend' => 'string', 'spend' => 'string', 'title_asset' => 'Object', 'unique_actions' => 'list<AdsActionStats>', 'unique_clicks' => 'string', 'unique_conversions' => 'list<AdsActionStats>', 'unique_ctr' => 'string', 'unique_inline_link_click_ctr' => 'string', 'unique_inline_link_clicks' => 'string', 'unique_link_clicks_ctr' => 'string', 'unique_outbound_clicks' => 'list<AdsActionStats>', 'unique_outbound_clicks_ctr' => 'list<AdsActionStats>', 'unique_video_continuous_2_sec_watched_actions' => 'list<AdsActionStats>', 'unique_video_view_10_sec' => 'list<AdsActionStats>', 'unique_video_view_15_sec' => 'list<AdsActionStats>', 'updated_time' => 'string', 'video_10_sec_watched_actions' => 'list<AdsActionStats>', 'video_15_sec_watched_actions' => 'list<AdsActionStats>', 'video_30_sec_watched_actions' => 'list<AdsActionStats>', 'video_asset' => 'Object', 'video_avg_percent_watched_actions' => 'list<AdsActionStats>', 'video_avg_time_watched_actions' => 'list<AdsActionStats>', 'video_continuous_2_sec_watched_actions' => 'list<AdsActionStats>', 'video_p100_watched_actions' => 'list<AdsActionStats>', 'video_p25_watched_actions' => 'list<AdsActionStats>', 'video_p50_watched_actions' => 'list<AdsActionStats>', 'video_p75_watched_actions' => 'list<AdsActionStats>', 'video_p95_watched_actions' => 'list<AdsActionStats>', 'video_play_actions' => 'list<AdsActionStats>', 'video_play_retention_0_to_15s_actions' => 'list<Object>', 'video_play_retention_20_to_60s_actions' => 'list<Object>', 'video_play_retention_graph_actions' => 'list<Object>', 'video_thruplay_watched_actions' => 'list<AdsActionStats>', 'video_time_watched_actions' => 'list<AdsActionStats>', 'website_ctr' => 'list<AdsActionStats>', 'website_purchase_roas' => 'list<AdsActionStats>', 'wish_bid' => 'string', 'id' => 'string');
    }
}
