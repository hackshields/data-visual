...
class MediaFingerprintFields extends AbstractEnum
{
    ...
    {
        return array('duration_in_sec' => 'float', 'expiration_time' => 'datetime', 'fingerprint_content_type' => 'string', 'fingerprint_type' => 'string', 'fingerprint_validity' => 'string', 'id' => 'string', 'metadata' => 'Object', 'title' => 'string', 'universal_content_id' => 'string');
    }
}
