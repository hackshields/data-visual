...
class CursorDegradationTest extends CursorTest
{
    ...
    {
        $url_fmt = $this->createUnparameterizedUrl() . '?offset=%s';
        $content = parent::createSampleResponseContent();
        $content['paging'] = array('next' => sprintf($url_fmt, $this->getUniquePageId()), 'previous' => sprintf($url_fmt, $this->getUniquePageId()));
        return $content;
    }
