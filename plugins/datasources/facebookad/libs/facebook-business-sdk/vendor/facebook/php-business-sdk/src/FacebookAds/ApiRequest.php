...
class ApiRequest
{
    ...
    public function __construct(Api $api, $id, $method, $endpoint, $return_prototype = null, $api_type = null, $accepted_fields = array(), TypeChecker $param_checker = null, $allow_file_upload = false, $use_graph_video_endpoint = false)
    {
        $this->fields = [];
        $this->params = [];
        $this->file_params = [];
    ...
    public function addParam($param, $value)
    {
        ...
        if (!ApiConfig::TYPE_CHECKER_STRICT_MODE || !$this->param_checker->isValidParam($param)) {
    ...
    {
        if (ApiConfig::TYPE_CHECKER_STRICT_MODE && !in_array($field, $this->accepted_fields)) {
