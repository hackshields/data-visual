...
class ReachFrequencyActivityFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'string', 'campaign_active' => 'bool', 'campaign_started' => 'bool', 'creative_uploaded' => 'bool', 'delivered_budget' => 'int', 'delivered_daily_grp' => 'list<float>', 'delivered_daily_impression' => 'list<float>', 'delivered_impression' => 'unsigned int', 'delivered_reach' => 'unsigned int', 'delivered_total_impression' => 'unsigned int', 'io_approved' => 'bool', 'sf_link' => 'string', 'id' => 'string');
    }
}
