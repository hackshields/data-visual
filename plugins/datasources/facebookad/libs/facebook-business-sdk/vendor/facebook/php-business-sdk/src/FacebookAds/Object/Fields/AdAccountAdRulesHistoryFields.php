...
class AdAccountAdRulesHistoryFields extends AbstractEnum
{
    ...
    {
        return array('evaluation_spec' => 'AdRuleEvaluationSpec', 'exception_code' => 'int', 'exception_message' => 'string', 'execution_spec' => 'AdRuleExecutionSpec', 'is_manual' => 'bool', 'results' => 'list<AdRuleHistoryResult>', 'rule_id' => 'int', 'schedule_spec' => 'AdRuleScheduleSpec', 'timestamp' => 'datetime', 'id' => 'string');
    }
}
