...
class IterativeSplitTestConfigFields extends AbstractEnum
{
    ...
    {
        return array('budget' => 'int', 'end_time' => 'datetime', 'guidance' => 'Object', 'id' => 'string', 'iterative_split_test_original_variant_id' => 'string', 'iterative_split_test_variant_to_split_mapping' => 'list<Object>', 'results_window' => 'Object', 'splits' => 'list<int>', 'start_time' => 'datetime', 'test_end_metrics_snapshot' => 'Object');
    }
}
