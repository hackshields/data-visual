...
class AlbumFields extends AbstractEnum
{
    ...
    {
        return array('backdated_time' => 'datetime', 'backdated_time_granularity' => 'string', 'can_backdate' => 'bool', 'can_upload' => 'bool', 'count' => 'unsigned int', 'cover_photo' => 'Photo', 'created_time' => 'datetime', 'description' => 'string', 'edit_link' => 'Object', 'event' => 'Event', 'from' => 'Object', 'id' => 'string', 'is_user_facing' => 'bool', 'link' => 'Object', 'location' => 'string', 'modified_major' => 'datetime', 'name' => 'string', 'photo_count' => 'unsigned int', 'place' => 'Place', 'privacy' => 'string', 'type' => 'string', 'updated_time' => 'datetime', 'video_count' => 'unsigned int');
    }
}
