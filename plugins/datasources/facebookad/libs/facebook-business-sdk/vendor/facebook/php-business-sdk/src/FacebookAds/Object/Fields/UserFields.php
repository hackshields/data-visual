...
class UserFields extends AbstractEnum
{
    ...
    {
        return array('about' => 'string', 'address' => 'Location', 'admin_notes' => 'list<PageAdminNote>', 'age_range' => 'AgeRange', 'birthday' => 'string', 'can_review_measurement_request' => 'bool', 'context' => 'UserContext', 'cover' => 'UserCoverPhoto', 'currency' => 'Currency', 'devices' => 'list<UserDevice>', 'education' => 'list<EducationExperience>', 'email' => 'string', 'employee_number' => 'string', 'favorite_athletes' => 'list<Experience>', 'favorite_teams' => 'list<Experience>', 'first_name' => 'string', 'gender' => 'string', 'hometown' => 'Page', 'id' => 'string', 'inspirational_people' => 'list<Experience>', 'install_type' => 'string', 'installed' => 'bool', 'interested_in' => 'list<string>', 'is_famedeeplinkinguser' => 'bool', 'is_shared_login' => 'bool', 'is_verified' => 'bool', 'labels' => 'list<PageLabel>', 'languages' => 'list<Experience>', 'last_name' => 'string', 'link' => 'string', 'local_news_megaphone_dismiss_status' => 'bool', 'local_news_subscription_status' => 'bool', 'locale' => 'string', 'location' => 'Page', 'meeting_for' => 'list<string>', 'middle_name' => 'string', 'name' => 'string', 'name_format' => 'string', 'payment_pricepoints' => 'PaymentPricepoints', 'political' => 'string', 'profile_pic' => 'string', 'public_key' => 'string', 'quotes' => 'string', 'relationship_status' => 'string', 'religion' => 'string', 'security_settings' => 'SecuritySettings', 'shared_login_upgrade_required_by' => 'datetime', 'short_name' => 'string', 'significant_other' => 'User', 'sports' => 'list<Experience>', 'test_group' => 'unsigned int', 'third_party_id' => 'string', 'timezone' => 'float', 'token_for_business' => 'string', 'updated_time' => 'datetime', 'verified' => 'bool', 'video_upload_limits' => 'VideoUploadLimits', 'viewer_can_send_gift' => 'bool', 'website' => 'string', 'work' => 'list<WorkExperience>');
    }
}
