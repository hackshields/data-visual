...
abstract class AbstractUnitTestCase extends AbstractTestCase
{
     ...
     * @var string
     */
    const FQN_JSON_AWARE_PARAMETERS = '\\FacebookAds\\Logger\\CurlLogger\\JsonAwareParameters';
    /**
     * @var string
     */
    ...
    {
        return $this->getMock(static::FQN_SESSION, array(), array(static::VALUE_SESSION_APP_ID, static::VALUE_SESSION_APP_SECRET, static::VALUE_SESSION_ACCESS_TOKEN));
    }
}
