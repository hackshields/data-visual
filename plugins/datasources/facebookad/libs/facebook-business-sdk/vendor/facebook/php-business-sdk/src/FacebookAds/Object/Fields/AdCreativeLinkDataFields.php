...
class AdCreativeLinkDataFields extends AbstractEnum
{
    ...
    {
        return array('additional_image_index' => 'int', 'app_link_spec' => 'AdCreativeLinkDataAppLinkSpec', 'attachment_style' => 'AttachmentStyle', 'branded_content_shared_to_sponsor_status' => 'string', 'branded_content_sponsor_page_id' => 'string', 'branded_content_sponsor_relationship' => 'string', 'call_to_action' => 'AdCreativeLinkDataCallToAction', 'caption' => 'string', 'child_attachments' => 'list<AdCreativeLinkDataChildAttachment>', 'collection_thumbnails' => 'list<AdCreativeCollectionThumbnailInfo>', 'custom_overlay_spec' => 'AdCreativeLinkDataCustomOverlaySpec', 'customization_rules_spec' => 'list<AdCustomizationRuleSpec>', 'description' => 'string', 'event_id' => 'string', 'force_single_link' => 'bool', 'format_option' => 'FormatOption', 'image_crops' => 'AdsImageCrops', 'image_hash' => 'string', 'image_layer_specs' => 'list<AdCreativeLinkDataImageLayerSpec>', 'image_overlay_spec' => 'AdCreativeLinkDataImageOverlaySpec', 'link' => 'string', 'message' => 'string', 'multi_share_end_card' => 'bool', 'multi_share_optimized' => 'bool', 'name' => 'string', 'offer_id' => 'string', 'page_welcome_message' => 'string', 'picture' => 'string', 'post_click_configuration' => 'AdCreativePostClickConfiguration', 'preferred_image_tags' => 'list<string>', 'retailer_item_ids' => 'list<string>', 'show_multiple_images' => 'bool', 'sponsorship_info' => 'AdCreativeLinkDataSponsorshipInfoSpec', 'static_fallback_spec' => 'AdCreativeStaticFallbackSpec', 'use_flexible_image_aspect_ratio' => 'bool', 'id' => 'string');
    }
}
