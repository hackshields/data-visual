...
class PageInsightsAsyncExportRunFields extends AbstractEnum
{
    ...
    {
        return array('data_level' => 'string', 'filters' => 'list<Object>', 'format' => 'string', 'gen_report_date' => 'int', 'id' => 'string', 'report_end_date' => 'int', 'report_start_date' => 'int', 'sorters' => 'list<Object>', 'status' => 'string');
    }
}
