...
class CurlLoggerTest extends AbstractLoggerTest
{
    ...
    protected function createRequestMock()
    {
        ...
        $query->method('export')->willReturn(array('appsecret_proof' => '<APPSECRET_PROOF>', 'access_token' => '<ACCESS_TOKEN>', 'query_field' => 'query_value'));
    ...
    {
        return array(array(RequestInterface::METHOD_GET), array(RequestInterface::METHOD_POST), array(RequestInterface::METHOD_PUT), array(RequestInterface::METHOD_DELETE));
    }
    /**
