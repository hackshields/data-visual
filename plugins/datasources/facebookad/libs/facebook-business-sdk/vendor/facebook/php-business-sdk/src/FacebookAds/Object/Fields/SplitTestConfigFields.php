...
class SplitTestConfigFields extends AbstractEnum
{
    ...
    {
        return array('budget' => 'int', 'early_winner_declaration_enabled' => 'bool', 'end_time' => 'datetime', 'extend_winner_enabled' => 'bool', 'splits' => 'list<int>', 'start_time' => 'datetime', 'test_variable' => 'string', 'id' => 'string');
    }
}
