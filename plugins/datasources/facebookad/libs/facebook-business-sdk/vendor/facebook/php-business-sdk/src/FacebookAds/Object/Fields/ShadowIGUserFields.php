...
class ShadowIGUserFields extends AbstractEnum
{
    ...
    {
        return array('biography' => 'string', 'business_discovery' => 'ShadowIGUser', 'followers_count' => 'int', 'follows_count' => 'int', 'id' => 'string', 'ig_id' => 'int', 'media_count' => 'int', 'mentioned_comment' => 'ShadowIGComment', 'mentioned_media' => 'ShadowIGMedia', 'name' => 'string', 'profile_picture_url' => 'string', 'username' => 'string', 'website' => 'string');
    }
}
