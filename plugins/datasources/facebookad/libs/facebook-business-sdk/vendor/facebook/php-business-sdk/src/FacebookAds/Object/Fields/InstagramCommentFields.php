...
class InstagramCommentFields extends AbstractEnum
{
    ...
    {
        return array('comment_type' => 'string', 'created_at' => 'datetime', 'id' => 'string', 'instagram_comment_id' => 'string', 'instagram_user' => 'InstagramUser', 'mentioned_instagram_users' => 'list<InstagramUser>', 'message' => 'string');
    }
}
