...
class AdPromotedObjectFields extends AbstractEnum
{
    ...
    {
        return array('application_id' => 'string', 'custom_conversion_id' => 'string', 'custom_event_type' => 'CustomEventType', 'event_id' => 'string', 'fundraiser_campaign_id' => 'string', 'object_store_url' => 'string', 'offer_id' => 'string', 'offline_conversion_data_set_id' => 'string', 'page_id' => 'string', 'pixel_aggregation_rule' => 'string', 'pixel_id' => 'string', 'pixel_rule' => 'string', 'place_page_set_id' => 'string', 'product_catalog_id' => 'string', 'product_item_id' => 'string', 'product_set_id' => 'string', 'retention_days' => 'string', 'id' => 'string');
    }
}
