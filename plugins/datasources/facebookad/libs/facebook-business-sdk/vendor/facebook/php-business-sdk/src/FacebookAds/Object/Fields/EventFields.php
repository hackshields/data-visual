...
class EventFields extends AbstractEnum
{
    ...
    {
        return array('attending_count' => 'int', 'can_guests_invite' => 'bool', 'category' => 'string', 'cover' => 'CoverPhoto', 'declined_count' => 'int', 'description' => 'string', 'discount_code_enabled' => 'bool', 'end_time' => 'string', 'event_times' => 'list<ChildEvent>', 'guest_list_enabled' => 'bool', 'id' => 'string', 'interested_count' => 'int', 'is_canceled' => 'bool', 'is_draft' => 'bool', 'is_page_owned' => 'bool', 'maybe_count' => 'int', 'name' => 'string', 'noreply_count' => 'int', 'owner' => 'Object', 'parent_group' => 'Group', 'place' => 'Place', 'scheduled_publish_time' => 'string', 'start_time' => 'string', 'ticket_uri' => 'string', 'ticket_uri_start_sales_time' => 'string', 'ticketing_privacy_uri' => 'string', 'ticketing_terms_uri' => 'string', 'timezone' => 'string', 'type' => 'Type', 'updated_time' => 'datetime');
    }
}
