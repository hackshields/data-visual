...
class BusinessActivityLogEventFields extends AbstractEnum
{
    ...
    {
        return array('acted_upon_business_id' => 'string', 'acted_upon_business_name' => 'string', 'acted_upon_business_object_id' => 'string', 'acted_upon_business_object_name' => 'string', 'acted_upon_business_object_type' => 'string', 'acted_upon_user_id' => 'string', 'acted_upon_user_name' => 'string', 'acting_business_id' => 'string', 'acting_business_name' => 'string', 'acting_user_id' => 'string', 'acting_user_name' => 'string', 'event_time' => 'unsigned int', 'event_type' => 'string', 'extra_data' => 'list<Object>', 'target_business_id' => 'string', 'target_business_name' => 'string', 'target_business_object_id' => 'string', 'target_business_object_name' => 'string', 'target_business_object_type' => 'string', 'id' => 'string');
    }
}
