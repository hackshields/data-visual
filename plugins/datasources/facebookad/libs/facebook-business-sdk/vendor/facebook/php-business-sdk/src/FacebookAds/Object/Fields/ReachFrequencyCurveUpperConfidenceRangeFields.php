...
class ReachFrequencyCurveUpperConfidenceRangeFields extends AbstractEnum
{
    ...
    {
        return array('impression_upper' => 'list<int>', 'num_points' => 'unsigned int', 'reach' => 'list<int>', 'reach_upper' => 'list<int>', 'uniq_video_views_2s_upper' => 'list<int>', 'video_views_2s_upper' => 'list<int>', 'id' => 'string');
    }
}
