...
class ReferralFields extends AbstractEnum
{
    ...
    {
        return array('id' => 'string', 'invite_limit' => 'int', 'messenger_cta' => 'string', 'messenger_promotion_text' => 'string', 'namespace' => 'string', 'need_promo_code' => 'bool', 'offer_origin' => 'string', 'promotion_text' => 'string', 'receiver_benefits_text' => 'string', 'referral_link_uri' => 'string', 'sender_benefits_text' => 'string');
    }
}
