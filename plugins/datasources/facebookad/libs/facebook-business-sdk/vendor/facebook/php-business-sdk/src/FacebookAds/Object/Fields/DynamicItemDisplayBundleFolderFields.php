...
class DynamicItemDisplayBundleFolderFields extends AbstractEnum
{
    ...
    {
        return array('categorization_criteria' => 'string', 'id' => 'string', 'name' => 'string', 'product_catalog' => 'ProductCatalog', 'product_set' => 'ProductSet', 'valid_labels' => 'list<Object>', 'bundles' => 'list<string>');
    }
}
