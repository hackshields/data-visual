...
class ReachFrequencyEstimatesPlacementBreakdownFields extends AbstractEnum
{
    ...
    {
        return array('android' => 'list<float>', 'audience_network' => 'list<float>', 'desktop' => 'list<float>', 'ig_android' => 'list<float>', 'ig_ios' => 'list<float>', 'ig_other' => 'list<float>', 'ig_story' => 'list<float>', 'instant_articles' => 'list<float>', 'instream_videos' => 'list<float>', 'ios' => 'list<float>', 'msite' => 'list<float>', 'suggested_videos' => 'list<float>', 'id' => 'string');
    }
}
