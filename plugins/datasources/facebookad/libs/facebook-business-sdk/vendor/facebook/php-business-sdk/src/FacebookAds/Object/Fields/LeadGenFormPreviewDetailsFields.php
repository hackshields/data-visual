...
class LeadGenFormPreviewDetailsFields extends AbstractEnum
{
    ...
    {
        return array('call_to_action_title' => 'string', 'default_appointment_scheduling_inline_context' => 'string', 'default_thank_you_page' => 'Object', 'edit_text' => 'string', 'email_inline_context_text' => 'string', 'next_button_text' => 'string', 'personal_info_text' => 'string', 'phone_number_inline_context_text' => 'string', 'review_your_info_text' => 'string', 'slide_to_submit_text' => 'string', 'submit_button_text' => 'string', 'id' => 'string');
    }
}
