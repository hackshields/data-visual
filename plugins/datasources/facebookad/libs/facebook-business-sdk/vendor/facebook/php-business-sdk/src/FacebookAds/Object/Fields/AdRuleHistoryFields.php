...
class AdRuleHistoryFields extends AbstractEnum
{
    ...
    {
        return array('evaluation_spec' => 'AdRuleEvaluationSpec', 'exception_code' => 'int', 'exception_message' => 'string', 'execution_spec' => 'AdRuleExecutionSpec', 'is_manual' => 'bool', 'results' => 'list<AdRuleHistoryResult>', 'schedule_spec' => 'AdRuleScheduleSpec', 'timestamp' => 'datetime', 'id' => 'string');
    }
}
