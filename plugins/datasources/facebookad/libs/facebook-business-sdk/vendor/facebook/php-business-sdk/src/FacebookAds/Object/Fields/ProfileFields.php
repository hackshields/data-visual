...
class ProfileFields extends AbstractEnum
{
    ...
    {
        return array('can_post' => 'bool', 'id' => 'string', 'link' => 'string', 'name' => 'string', 'pic' => 'string', 'pic_crop' => 'ProfilePictureSource', 'pic_large' => 'string', 'pic_small' => 'string', 'pic_square' => 'string', 'profile_type' => 'ProfileType', 'username' => 'string');
    }
}
