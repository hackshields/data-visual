...
class RequestTest extends AbstractUnitTestCase
{
    ...
    public function testDomain()
    {
        ...
        $client = $this->createClientMock();
        $client->method('getDefaultGraphBaseDomain')->willReturn('not.facebook.com');
        $request = new Request($client);
        ...
        // Partially set
        $client = $this->createClientMock();
        $client->method('getDefaultGraphBaseDomain')->willReturn('probably.not.facebook.com');
        $request = new Request($client);
    ...
    public function testUrl()
    {
        ...
        // With query
        $params = array('sdk' => 'PHP', 'names' => 'abc,def');
