...
class LeadGenDataDraftFields extends AbstractEnum
{
    ...
    {
        return array('block_display_for_non_targeted_viewer' => 'bool', 'context_card' => 'Object', 'created_time' => 'datetime', 'creator_id' => 'string', 'follow_up_action_url' => 'string', 'id' => 'string', 'is_optimized_for_quality' => 'bool', 'legal_content' => 'Object', 'locale' => 'string', 'name' => 'string', 'page' => 'Page', 'question_page_custom_headline' => 'string', 'questions' => 'list<LeadGenDraftQuestion>', 'status' => 'string', 'thank_you_page' => 'Object', 'tracking_parameters' => 'list<Object>');
    }
}
