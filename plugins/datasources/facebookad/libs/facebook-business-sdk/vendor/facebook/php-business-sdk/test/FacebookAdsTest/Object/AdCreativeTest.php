...
class AdCreativeTest extends AbstractCrudObjectTestCase
{
    public function testCrud()
    {
        ...
        $this->assertCanUpdate($creative, array(AdCreativeFields::NAME => 'My Test Ad ' . $this->getConfig()->testRunId));
    ...
    public function testMultiProductObjectSpec()
    {
        ...
        $product1 = (new AttachmentData())->setData(array(AttachmentDataFields::LINK => $this->getConfig()->appUrl . 'p1', AttachmentDataFields::IMAGE_HASH => $adImage->hash, AttachmentDataFields::NAME => 'Product 1', AttachmentDataFields::DESCRIPTION => '$100'));
        $product2 = (new AttachmentData())->setData(array(AttachmentDataFields::LINK => $this->getConfig()->appUrl . 'p2', AttachmentDataFields::IMAGE_HASH => $adImage->hash, AttachmentDataFields::NAME => 'Product 2', AttachmentDataFields::DESCRIPTION => '$200'));
        $product3 = (new AttachmentData())->setData(array(AttachmentDataFields::LINK => $this->getConfig()->appUrl . 'p3', AttachmentDataFields::IMAGE_HASH => $adImage->hash, AttachmentDataFields::NAME => 'Product 3', AttachmentDataFields::DESCRIPTION => '$300'));
