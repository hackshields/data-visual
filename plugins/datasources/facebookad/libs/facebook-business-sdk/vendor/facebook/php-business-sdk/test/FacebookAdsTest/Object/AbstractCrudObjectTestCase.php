...
abstract class AbstractCrudObjectTestCase extends AbstractIntegrationTestCase
{
     ...
     * @param array $params
     */
    public function assertCanCreate(AbstractCrudObject $subject, array $params = array())
    {
    ...
    public function assertCanRead(AbstractCrudObject $subject)
    {
        ...
        $mirror->read();
        $this->assertEquals($subject->{AbstractCrudObject::FIELD_ID}, $mirror->{AbstractCrudObject::FIELD_ID});
    }
    /**
     * @param AbstractCrudObject $subject
     ...
     * @return mixed
     */
    protected function fetchConnection(AbstractCrudObject $subject, $connection_name, array $fields = array(), array $params = array())
    {
        $this->assertNotEmpty($subject->{AbstractCrudObject::FIELD_ID});
        $mirror = $this->getEmptyClone($subject);
     ...
     * @param array $params
     */
    public function assertCanFetchConnection(AbstractCrudObject $subject, $connection_name, array $fields = array(), array $params = array())
    {
        $result = $this->fetchConnection($subject, $connection_name, $fields, $params);
        $this->assertTrue($result instanceof Cursor || $result instanceof AbstractObject);
    }
    /**
     * @param AbstractCrudObject $subject
     * @param string $connection_name
     ...
     * @param array $params
     */
    public function assertCanFetchConnectionAsArray(AbstractCrudObject $subject, $connection_name, array $fields = array(), array $params = array())
    {
        $result = $this->fetchConnection($subject, $connection_name, $fields, $params);
     ...
     */
    public function assertCanUpdate(AbstractCrudObject $subject, array $diff)
    {
        $this->assertNotEmpty($subject->{AbstractCrudObject::FIELD_ID});
        $mirror = $this->getEmptyClone($subject);
        $mirror->read();
        ...
        $this->assertEquals($this->extractDiffFromObject($mirror, $diff), $this->extractDiffFromObject($mirror2, $diff));
     ...
     * @param string $status
     */
    private function assertArchivableCrudObjectStatus(AbstractArchivableCrudObject $subject, $status)
    {
        $fields = array(AbstractArchivableCrudObjectFields::CONFIGURED_STATUS, AbstractArchivableCrudObjectFields::EFFECTIVE_STATUS);
        $mirror = $this->getEmptyClone($subject);
        $mirror->read($fields);
    ...
    public function assertCanDelete(AbstractCrudObject $subject)
    {
        ...
        if ($subject instanceof AbstractArchivableCrudObject) {
            $this->assertArchivableCrudObjectStatus($subject, AbstractArchivableCrudObject::STATUS_DELETED);
        }
    }
    /**
     * @param AbstractCrudObject $subject
