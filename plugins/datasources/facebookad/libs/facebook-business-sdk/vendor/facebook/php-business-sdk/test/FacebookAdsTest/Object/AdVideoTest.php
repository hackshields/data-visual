...
class AdVideoTest extends AbstractCrudObjectTestCase implements SkippableFeatureTestInterface
{
    /**
     * @return array
     */
    ...
    public function testCrud()
    {
        ...
        $this->assertCanUpdate($video, array(AdVideoFields::NAME => $this->getConfig()->testRunId . ' updated'));
