...
class AbstractObject
{
    ...
    public function __construct()
    {
        ...
        $this->_type_checker = new TypeChecker(static::getFieldTypes(), static::getReferencedEnums());
    }
    ...
    {
        if (ApiConfig::TYPE_CHECKER_STRICT_MODE && $this->_type_checker->isValidParam($name)) {
