...
class AdAssetFeedSpecLinkURLFields extends AbstractEnum
{
    ...
    {
        return array('adlabels' => 'list<AdAssetFeedSpecAssetLabel>', 'carousel_see_more_url' => 'string', 'deeplink_url' => 'string', 'display_url' => 'string', 'url_tags' => 'string', 'website_url' => 'string', 'id' => 'string');
    }
}
