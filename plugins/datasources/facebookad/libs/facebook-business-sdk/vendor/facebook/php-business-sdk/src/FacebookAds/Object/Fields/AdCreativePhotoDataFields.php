...
class AdCreativePhotoDataFields extends AbstractEnum
{
    ...
    {
        return array('branded_content_shared_to_sponsor_status' => 'string', 'branded_content_sponsor_page_id' => 'string', 'branded_content_sponsor_relationship' => 'string', 'caption' => 'string', 'image_hash' => 'string', 'page_welcome_message' => 'string', 'url' => 'string', 'id' => 'string');
    }
}
