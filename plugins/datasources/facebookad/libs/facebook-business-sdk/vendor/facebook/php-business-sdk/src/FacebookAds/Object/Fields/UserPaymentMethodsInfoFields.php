...
class UserPaymentMethodsInfoFields extends AbstractEnum
{
    ...
    {
        return array('account_id' => 'string', 'available_card_types' => 'list<string>', 'available_payment_methods' => 'list<string>', 'available_payment_methods_details' => 'list<Object>', 'country' => 'string', 'currency' => 'string', 'existing_payment_methods' => 'list<Object>', 'id' => 'string');
    }
}
