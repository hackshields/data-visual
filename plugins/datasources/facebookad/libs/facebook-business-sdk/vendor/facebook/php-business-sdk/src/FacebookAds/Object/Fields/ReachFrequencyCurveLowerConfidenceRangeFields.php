...
class ReachFrequencyCurveLowerConfidenceRangeFields extends AbstractEnum
{
    ...
    {
        return array('impression_lower' => 'list<int>', 'num_points' => 'unsigned int', 'reach' => 'list<int>', 'reach_lower' => 'list<int>', 'uniq_video_views_2s_lower' => 'list<int>', 'video_views_2s_lower' => 'list<int>', 'id' => 'string');
    }
}
