...
class LookalikeSpecFields extends AbstractEnum
{
    ...
    {
        return array('country' => 'string', 'is_financial_service' => 'bool', 'origin' => 'list<Object>', 'origin_event_source_name' => 'string', 'origin_event_source_type' => 'string', 'product_set_name' => 'string', 'ratio' => 'float', 'starting_ratio' => 'float', 'target_countries' => 'list<string>', 'type' => 'string', 'id' => 'string');
    }
}
