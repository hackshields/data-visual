...
class AbstractIntegrationTestCase extends AbstractTestCase
{
    ...
    {
        $this->session = new Session($this->getConfig()->appId, $this->getConfig()->appSecret, $this->getConfig()->accessToken);
    }
    ...
    {
        $this->logger = $this->getConfig()->curlLogger ? new CurlLogger(fopen($this->getConfig()->curlLogger, "a")) : new NullLogger();
    }
