...
<head>
    ...
    <link rel="SHORTCUT ICON" href="//assets.dbface.com/favicon.ico" type="image/x-icon" />
    <link rel="ICON" href="//assets.dbface.com/favicon.ico" type="image/ico" />
...
?>)
    ...
    <script src="js/instance.js?v=<?php 
echo time();
?>"></script>
    <div id="message"></div>
    <?php 
...
if (!isset($_SESSION['user'])) {
    ...
    if (!$users && !$projects && !$active) {
        ...
        ?>
            ...
            <form id="login" method="post" style="position: fixed; width: 350px; top: 30%; left: 50%; margin-left: -175px; padding: 35px;">
                ...
                <label><span class="icon-user login-icon"></span> <?php 
        i18n("Username");
        ?></label>
                <input type="text" name="username" autofocus="autofocus" autocomplete="off">

                <label><span class="icon-lock login-icon"></span> <?php 
        i18n("Password");
        ?></label>
                <input type="password" name="password">
                
                <div class="language-selector">
                    <label><span class="icon-picture login-icon"></span> <?php 
        i18n("Theme");
        ?></label>
        ...
        ?>
                    ...
                    <label><span class="icon-language login-icon"></span> <?php 
        i18n("Language");
        ?></label>
        ...
        ?></button>
                ...
                <a class="show-language-selector"><?php 
        i18n("More");
        ?></a>
        ...
        ?> </h2>
                <div id="finder-wrapper">
                   ...
                   <ul id="finder-options-menu" class="options-menu">
                      <li class="chosen"><a data-option="left_prefix"><?php 
        i18n("Prefix");
        ?></a></li>
                      <li><a data-option="substring"><?php 
        i18n("Substring");
        ?></a></li>
                      <li><a data-option="regexp"><?php 
        i18n("Regular expression");
        ?></a></li>
                      <li><a data-action="search"><?php 
        i18n("Search File Contents");
        ?></a></li>
                   </ul>
                </div>
                <?php 
    ...
    i18n("Projects");
    ?></h2>
                        <a id="projects-collapse" class="icon-down-dir icon" alt="<?php 
    i18n("Collapse");
    ?>"></a>
                    </div>
    ...
    ?>: 0</div>
        ...
        <div id="editor-region">
            <div id="editor-top-bar">
                ...
                <div id="tab-close">
                    <a id="tab-close-button" class="icon-cancel-circled" title="<?php 
    i18n("Close All");
    ?>"></a>
                </div>
            ...
            <div id="editor-bottom-bar">
                <a id="settings" class="ico-wrapper"><span class="icon-doc-text"></span><?php 
    i18n("Settings");
    ?></a>
    ...
    ?>
                ...
                <a id="split" class="ico-wrapper"><span class="icon-layout"></span><?php 
    i18n("Split");
    ?></a>
                <div class="divider"></div>
            ...
            <ul id="split-options-menu" class="options-menu">
              <li id="split-horizontally"><a> <?php 
    i18n("Split Horizontally");
    ?> </a></li>
              <li id="split-vertically"><a> <?php 
    i18n("Split Vertically");
    ?> </a></li>
              <li id="merge-all"><a> <?php 
    i18n("Merge all");
    ?> </a></li>
            </ul>
        </div>
    ...
    foreach ($right_bar as $item_rb => $data) {
        ...
        if ($data['title'] == 'break') {
            ...
            if ($data['title'] != 'break' && $data['title'] != 'pluginbar' && $data['onclick'] == '') {
                if (!$data['admin'] || $data['admin'] && checkAccess()) {
                    echo "<hr><div class='sb-right-category'>" . get_i18n($data['title']) . "</div>";
                }
            } else {
                if ($data['title'] == 'pluginbar') {
                    if (!$data['admin'] || $data['admin'] && checkAccess()) {
                        foreach ($plugins as $plugin) {
                            if (file_exists(PLUGINS . "/" . $plugin . "/plugin.json")) {
                                $pdata = file_get_contents(PLUGINS . "/" . $plugin . "/plugin.json");
    ...
    <!-- ACE -->
    <script src="//assets.dbface.com/libs/ace/ace.js"></script>
