...
if (!function_exists("get_config")) {
    ...
    function &get_config(array $replace = array())
    {
        ...
        if (empty($config)) {
            ...
            if (file_exists($file_path = FCPATH . "config/config.php")) {
                require $file_path;
            }
...
if (!function_exists("_error_handler")) {
    ...
    {
        $is_error = ((1 | 4 | 64 | 16 | 256) & $severity) === $severity;
        if ($is_error) {
