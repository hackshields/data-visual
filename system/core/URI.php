...
/**
	 ...
	 * @var	string
	 */
    protected $_permitted_uri_chars = NULL;
    ...
    public function __construct(CI_Config $config)
    {
        ...
        empty($protocol) and switch( $protocol ) 
{
    case "AUTO":
    case "REQUEST_URI":
    ...
    protected function _set_uri_string($str, $is_cli = false)
    {
        ...
        else
        {
            ...
            {
                $slen = strlen($suffix);
                if( substr($this->uri_string, 0 - $slen) === $suffix ) 
                {
                    $this->uri_string = substr($this->uri_string, 0, 0 - $slen);
                }
    ...
    protected function _uri_to_assoc($n = 3, $default = array(  ), $which = "segment")
    {
        ...
        if( isset($this->keyval[$which]) && isset($this->keyval[$which][$n]) ) 
        {
            return $this->keyval[$which][$n];
        }

        $total_segments = "total_" . $which . "s";
        $segment_array = (string) $which . "_array";
