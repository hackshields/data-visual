...
/**
    ...
    public function __construct($params)
    {
        ...
        if( $this->hostname !== "" && strpos($this->hostname, "/") === false && strpos($this->hostname, ":") === false && (!empty($this->port) && ctype_digit($this->port) || $this->database !== "") ) 
        {
    ...
    public function version()
    {
        ...
        if( !$this->conn_id || ($version_string = oci_server_version($this->conn_id)) === false ) 
        {
            return false;
        }
